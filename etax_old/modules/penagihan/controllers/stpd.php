...
class Stpd extends Master_Controller
{
	...
	function add()
	{
		...
		$data['title'] = 'Penagihan | Rekam STPD';
		$data['title_icon'] = 'pe-7s-news-paper';
		$data['content'] = 'Penagihan';
		$data['content_desc'] = '';
		$page = 'penagihan/add_stpd';
	...
	function cetak_stpd()
	{
		...
		$data['title'] = 'Penagihan | Cetak STPD';
		$data['title_icon'] = 'pe-7s-news-paper';
		$data['content'] = 'Penagihan';
		$data['content_desc'] = '';
		$page = 'penagihan/form_cetak_stpd';
		echo modules::run('layouts/loadview', $data, $page);
	...
	function cetak_daftar_stpd()
	{
		...
		$data['content'] = 'Penagihan';
		$data['content_desc'] = '';
		$page = 'penagihan/form_cetak_daftar_stpd';
		echo modules::run('layouts/loadview', $data, $page);
	...
	/**
	 * cetak daftar stpd excel
	 */
	function excel_cetak_daftar()
	{
		// $mengetahui = $this->common_model->get_query('*', 'v_pejabat_daerah', "pejda_id='" . $this->input->get('mengetahui') . "'");
		// $data['mengetahui'] = $mengetahui->row();
		...
		$this->load->view('xls_daftar_stpd', $data);
	}
