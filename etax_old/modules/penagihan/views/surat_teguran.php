	...
	<div class="m">
		<form name="frm_daftar_kartu_data" id="frm_daftar_kartu_data">
			<table class="admintable">
				...
				<tr>
					<td width="150" class="key">Periode</td>
					<td>
						<!--	<label class="key">Tahun</label> -->

						<input type="text" name="tgl_awal" class="mandatory" id="tgl_awal" size="11" />
						<label class="key">s/d</label>
						<input type="text" name="tgl_akhir" class="mandatory" id="tgl_akhir" size="11" />
						<!--
						<input type="text" name="tahun_awal" id="tahun_awal" class="inputbox" size="4" maxlength="4" value="<? //=date('Y')-1 
																															?>" tabindex="3" />
						--> <?php
						...
						<!--
						<label class="key">s/d</label> 
						<input type="text" name="tahun" id="tahun" class="inputbox" size="4" maxlength="4" value="<? //= date('Y') 
																													?>" tabindex="3" />
					-->
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="hidden" name="npwrd" id="npwrd">
						<input type="hidden" namw="wp_wr_camat" id="wp_wr_camat">
						...
						<input type="button" id="btn_npwpd_teguran" size="2" value="...">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td></td>
					<td>
						<input type="button" name="btn_daftar" id="btn_daftar" value=" Lihat Daftar " />
						&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
	...
	GLOBAL_SURAT_TEGURAN_VARS["cetak_teguran_reklame"] = "<?= base_url(); ?>penagihan/surat_teguran/pdf_surat_teguran_reklame";
	GLOBAL_SURAT_TEGURAN_VARS["cetak"] = "<?= base_url(); ?>penagihan/surat_teguran/pdf_surat_teguran";
	GLOBAL_SURAT_TEGURAN_VARS["daftar"] = "<?= base_url(); ?>penagihan/surat_teguran/pdf_daftar_surat_teguran";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/penagihan/scripts/surat_teguran.js"></script>