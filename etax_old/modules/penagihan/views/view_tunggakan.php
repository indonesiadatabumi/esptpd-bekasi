				...
				<tr>
					<td valign="top">
						<form id="frm_view_sts">
							...
							<table class="admintable">
								<tr>
									<td class="title_key">Mengetahui</td>
									<td>
										<?php
								...
								<tr>
									<td class="title_key">Diperiksa oleh</td>
									<td>
										<?php
								...
								<tr>
									<td class="title_key">Tgl. Cetak</td>
									<td>
...
<script type="text/javascript" src="<?= base_url(); ?>modules/penagihan/scripts/view_tunggakan.js"></script>