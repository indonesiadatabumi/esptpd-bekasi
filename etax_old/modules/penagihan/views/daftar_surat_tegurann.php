...
<div id="element-box">
	...
	<div class="m">
		<form name="frm_daftar_surat_tegurann" id="frm_daftar_surat_tegurann">
...
<script type="text/javascript">
	var GLOBAL_DAFTAR_SURAT_TEGURANN_VARS = new Array();
	GLOBAL_DAFTAR_SURAT_TEGURANN_VARS["cetak"] = "<?= base_url(); ?>pendataan/surat_tegurann/pdf_daftar_surat_tegurann";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/daftar_surat_tegurann.js"></script>