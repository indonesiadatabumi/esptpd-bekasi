<div id="toolbar-box">
	...
	<div class="m">
		...
		<div class="header icon-48-penetapan">
			Form Penetapan STPD: <small><small id='title_head'>[ Baru ]</small></small>
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
...
<div id="element-box">
	...
	<div class="m">
		...
		$attributes = array('id' => 'frm_penetapan_stpd');
		$hidden = array('mode' => 'add');
		echo form_open('frm_penetapan_stpd', $attributes, $hidden);
		?>
...
<script type="text/javascript">
	var GLOBAL_FORM_STPD_VARS = new Array();
	GLOBAL_FORM_STPD_VARS["get_spt"] = "<?= base_url(); ?>penagihan/stpd/get_spt";
	GLOBAL_FORM_STPD_VARS["insert"] = "<?= base_url(); ?>penagihan/stpd/insert";
	GLOBAL_FORM_STPD_VARS["view"] = "<?= base_url(); ?>penagihan/stpd";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/penagihan/scripts/form_stpd.js"></script>