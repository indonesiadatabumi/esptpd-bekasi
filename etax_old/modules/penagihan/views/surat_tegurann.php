...
<script type="text/javascript">
	var GLOBAL_SURAT_TEGURANN_VARS = new Array();
	GLOBAL_SURAT_TEGURANN_VARS["cetak"] = "<?= base_url(); ?>penagihan/surat_tegurann/pdf_surat_tegurann";
	GLOBAL_SURAT_TEGURANN_VARS["daftar"] = "<?= base_url(); ?>penagihan/surat_tegurann/pdf_daftar_surat_tegurann";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/penagihan/scripts/surat_tegurann.js"></script>