...
<div id="element-box">
	...
	<div class="m">
		<form action="<? //php echo $myself.$XFA['dsp_cetak_buku_kendali']; 
							...
							<TD valign="top">
								<table class="admintable" border=0 cellspacing="1">
									...
									<tr>
										...
										<td>
											<input type="text" name="masa1" id="f_date_a" size="11" value="" <?php //echo $dis; 
																												?> onchange="dateFormat(this);" tabindex="2" />
											&nbsp; S/D &nbsp;
											<input type="text" name="masa2" id="f_date_b" size="11" value="" <?php //echo $dis; 
																												?> onchange="dateFormat(this);" tabindex="3" />
										</td>
									</tr>
									<tr>
										...
										<td>
											<input type="hidden" name="spt_kode_rek" id="spt_kode_rek" value="<? //=$ar_edit_data[spt_kode_rek];
																												?>">
											<input type="text" name="korek" id="korek" class="inputbox" size="5" maxlength="5" value="<? //= $ar_edit_data[koderek]; 
																																		?>" onchange="submitSignup('chosen_korek');" onkeypress="submitSignup('chosen_korek');" tabindex="4" />
											Jenis
											<input type="text" name="korek_rincian" id="korek_rincian" class="inputbox" size="2" maxlength="2" value="<? //= $ar_edit_data[korek_rincian]; 
																																						?>" onchange="submitSignup('chosen_korek');" onkeypress="submitSignup('chosen_korek');" tabindex="5" />
											Klas
											<input type="text" name="korek_sub1" id="korek_sub1" class="inputbox" size="2" maxlength="2" value="<? //= $ar_edit_data[korek_sub1]; 
																																				?>" onchange="submitSignup('chosen_korek');" onkeypress="submitSignup('chosen_korek');" tabindex="6" />
									...
									<tr>
										...
										<td>
											<input type="text" name="korek_nama" id="korek_nama" class="inputbox" size="40" value="<? //= $ar_edit_data[korek_nama]; 
																																	?>" readonly="true" />
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<input type="text" name="opr_nama" id="opr_nama" class="inputbox" size="30" value="<? //=$ar_operator['opr_nama']
																																?>" readonly="true" />
										</td>
									</tr>
									<tr>
										...
										<td>
											<input type="text" name="ref_jab_nama" id="ref_jab_nama" class="inputbox" size="30" value="<? //=$ar_operator['ref_jab_nama']
																																		?>" readonly="true" />
										</td>
									</tr>
									<tr>
										<td class="key">NIP</td>
										<td>
											<input type="text" name="opr_nip" id="opr_nip" class="inputbox" size="30" value="<? //=format_nip ($ar_operator['opr_nip'])
																																?>" readonly="true" />
										</td>
									</tr>
									<tr>
			...
			<input type="hidden" name="4e5df0df35b0914f3fbb6b63af22c21d" value="1" />
		</form>
		<div class="clr"></div>
	</div>
	<div class="b">
...
<script type="text/javascript" src="<?= base_url(); ?>modules/penagihan/scripts/form_cetak_buku_kendali.js"></script>