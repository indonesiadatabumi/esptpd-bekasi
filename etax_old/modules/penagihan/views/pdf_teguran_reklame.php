...
foreach ($ar_wp as $wp){
    ...
    $pdf->Image($logo,13,10,16);

    $pdf->MultiCell(180, 3, $pdf->Cell(1, 4, "", '', 0, 'C') . $pdf->SetFont('Arial', '', 14) . $pdf->Cell(210, 4, "PEMERINTAH KOTA BEKASI", '', 0, 'C'), '', '', 'L');
    $pdf->MultiCell(180, 3, $pdf->Cell(1, 4, "", '', 0, 'C') . $pdf->SetFont('Arial', 'B', 14) . $pdf->Cell(210, 8, "BADAN PENDAPATAN DAERAH", '', 0, 'C'), '', '', 'L');
    $pdf->MultiCell(180, 3, $pdf->Cell(1, 3, "", '', 0, 'C') . $pdf->Cell(210, 9, $pdf->SetFont('Arial', '', 7) . "Jl. Ir. H. Juanda No. 100 Telp. (021) 88397963, Fax (021) 88397965", '', 0, 'C'), '', '', 'L');
    $pdf->MultiCell(180, 3, $pdf->Cell(1, 3, "", '', 0, 'C') . $pdf->Cell(210, 10, $pdf->SetFont('Arial', 'B', 10) . "B E K A S I ", '', 0, 'C'), '', '', 'L');
    ...
    $pdf->SetXY(130,$y);
    $pdf->MultiCell(70,5,"Bekasi, ".format_tgl($_GET['tgl_cetak'],false,true),0,'L',0);

    $pdf->ln();
    $y = $pdf->GetY();
    $pdf->MultiCell(90,5,"",0,'L',0);
    $pdf->SetXY(130,$y);
    $pdf->MultiCell(70,5,"Kepada",0,'L',0);

    $pdf->ln(0);
    $y = $pdf->GetY();
    $pdf->MultiCell(120,5,"Nomor                 :       /           -Bapenda.Wasdalpenda                           Yth.",0,'L',0);
    $pdf->SetXY(130,$y);
    $pdf->MultiCell(70,5,"". $wp['wp_wr_nama'],0,'L',0);

    $pdf->ln(0);
    $y = $pdf->GetY();
    $pdf->MultiCell(90,5,"Sifat                     :  Segera",0,'L',0);
    $pdf->SetXY(130,$y);
    $pdf->MultiCell(70,5,"",0,'L',0);

    $pdf->ln(0);
    $y = $pdf->GetY();
    $pdf->MultiCell(90,5,"Lampiran             :  -",0,'L',0);
    $pdf->SetXY(130,$y);
    $pdf->MultiCell(70,5,"",0,'L',0);

    $pdf->ln(0);
    $y = $pdf->GetY();
    $pdf->MultiCell(90,5,"Hal                       :  Pemberitahuan",0,'L',0);
    $pdf->SetXY(130,$y);
    ...
    $pdf->MultiCell(90,5,"",0,'L',0);
    $pdf->SetXY(130,$y);
    $pdf->MultiCell(70,5,"di-",0,'L',0);

    $pdf->ln(0);
    $y = $pdf->GetY();
    $pdf->MultiCell(90,5,"",0,'L',0);
    $pdf->SetXY(140,$y);
    $pdf->MultiCell(60,5,"Bekasi",0,'L',0);
    ...
    $pdf->MultiCell(90,5,"",0,'L',0);
    $pdf->SetXY(110,$y);
    $pdf->MultiCell(80,5,"".$pejabat->ref_japeda_nama,0,'C',0);

    $pdf->ln(30);
    $y = $pdf->GetY();
    $pdf->SetFont('Arial', 'BU', 10);
    $pdf->MultiCell(100,5,"",0,'L',0);
    $pdf->SetXY(120,$y);
    $pdf->MultiCell(70,5,"".$pejabat->pejda_nama,0,'L',0);
    ...
    $pdf->MultiCell(100,5,"",0,'L',0);
    $pdf->SetXY(120,$y);
    $pdf->MultiCell(70,5,"".$pejabat->ref_pangpej_ket,0,'L',0);
    ...
    $pdf->MultiCell(100,5,"",0,'L',0);
    $pdf->SetXY(120,$y);
    $pdf->MultiCell(70,5,"NIP. ". $pejabat->pejda_nip,0,'L',0);
