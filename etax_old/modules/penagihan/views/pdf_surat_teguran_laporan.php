...
if (!empty($ar_wp)) {
	...
	//	$s_title = strtoupper($v['ketspt_singkat']); 
		...
		$tbd[1]['TEXT'] = "Berdasarkan catatan kami, ternyata sampai saat ini Saudara belum memasukan Surat Pemberitahuan Pajak Daerah Masa Pajak".$masa_pajak." ".$_GET['tahun']."Maka dengan ini kami minta agar saudara menyerahkan SPTPD paling lambat 7 (tujuh) hari setelah menerima Surat ini.";
		$tbd[1]['COLSPAN'] = 2;
		$tbd[1]['T_ALIGN'] = "L";
		$tbd[3]['TEXT'] = "";	
		$pdf->tbDrawData($tbd);		
		...
		$dt[0]['TEXT'] = "";
		$dt[1]['TEXT'] = "Apabila Surat Teguran ini tidak juga Saudara indahkan, Maka kami akan melakukan Penetapan Atas Objek Pajak yang Saudara miliki secara Jabatan, yang akan merugikan Saudara sendiri.";
		$dt[1]['COLSPAN'] = 2;
		$dt[1]['LN_SIZE'] = 4;
		$dt[1]['T_ALIGN'] = 'J';
		$dt[3]['TEXT'] = "";
		...
		$dt[0]['TEXT'] = "";
		$dt[1]['TEXT'] = "Untuk menjadi perhatian Saudara, agar kewajiban Saudara dapat dipenuhi sebagai mana mestinya.\n\n\n";
		$dt[1]['COLSPAN'] = 2;
		$dt[1]['LN_SIZE'] = 4;
		$dt[3]['TEXT'] = "";
		$dt[1]['BRD_TYPE'] = '0';
	...
	// 	$dt[1]['BRD_TYPE'] = '';$dt[2]['BRD_TYPE'] = ''; // garis tabel
		...
		$dt[0]['TEXT'] = "";
		$dt[1]['TEXT'] = "NPWPD : ".strtoupper($v['npwprd']);
		$dt[2]['TEXT'] = "";
		$dt[3]['TEXT'] = "";
		$dt[1]['COLSPAN'] = 4;
		$dt[1]['LN_SIZE'] = 4;
		...
		$dt[0]['TEXT'] = "";
		$dt[1]['TEXT'] = "NAMA : ".strtoupper($v['wp_wr_nama']);
		$dt[2]['TEXT'] = "";
		$dt[3]['TEXT'] = "";
		$dt[1]['COLSPAN'] = 4;
		$dt[1]['LN_SIZE'] = 4;
		...
		$dt[0]['TEXT'] = "";
		// $dt[1]['TEXT'] = "ALAMAT              : ".strtoupper(ereg_replace("\r|\n","",$v[wp_wr_almt]))." KEL. ".strtoupper($v[wp_wr_lurah]." KEC. ".$v[wp_wr_camat])."";$dt[2]['TEXT'] = "";$dt[3]['TEXT'] = "";
		$dt[1]['TEXT'] = "ALAMAT : ".strtoupper($v['wp_wr_almt'])." KEL. ".strtoupper($v['wp_wr_lurah']." KEC. ".$v['wp_wr_camat']);
		$dt[2]['TEXT'] = "";
		$dt[3]['TEXT'] = "";
		$dt[1]['COLSPAN'] = 4;
		$dt[1]['LN_SIZE'] = 4;
		...
		$dt[1]['TEXT'] = "";
		$dt[2]['TEXT'] = "";
		$dt[3]['TEXT'] = "BEKASI, ".strtoupper(format_tgl($_GET['tgl_cetak'],false,true));
		$dt[1]['T_ALIGN'] = "C";
		$dt[3]['T_SIZE']=8;
		$dt[0]['LN_SIZE'] = 8;
		$dt[1]['LN_SIZE'] = 8;
