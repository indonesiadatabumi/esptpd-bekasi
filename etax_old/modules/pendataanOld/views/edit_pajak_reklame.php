								...
								<tfoot>
									<tr>
										<td align="center">
											...
											&nbsp;&nbsp;&nbsp;<b>TOTAL PAJAK</b> &nbsp;&nbsp;&nbsp;
											<input type="text" name="spt_pajak" id="spt_pajak" value="<?= format_currency($row->spt_pajak); ?>" class="inputbox" size="20" value="" onfocus="this.value=unformatCurrency(this.value);" onblur="this.value=formatCurrency(this.value);" readonly="true" style="font-weight:bold;font-size:25px;color:#18F518;background-color:black;text-align:right;" />
										</td>
									</tr>
								</tfoot>
							</table>
...
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/edit_pajak_reklame.js"></script>