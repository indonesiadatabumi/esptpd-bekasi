<div id="toolbar-box">
	...
	<div class="m">
		<div class="header icon-48-print">
			Cetak Kartu Data Pajak PPJ Non PLN
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
...
<div id="element-box">
	...
	<div class="m">
		<form name="frm_kartu_data_restoran" id="frm_kartu_data_restoran">
			<input type="hidden" name="kodus_id" value="<?= $this->config->item('kodus_genset'); ?>">
...
<script type="text/javascript">
	var GLOBAL_KARTU_DATA_GENSET_VARS = new Array();
	GLOBAL_KARTU_DATA_GENSET_VARS["cetak"] = "<?= base_url(); ?>pendataan/kartu_data/pdf_pajak_genset";
</script>

<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/kartu_data_genset.js"></script>