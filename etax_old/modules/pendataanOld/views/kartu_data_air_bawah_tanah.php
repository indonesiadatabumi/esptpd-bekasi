<div id="toolbar-box">
	...
	<div class="m">
		<div class="header icon-48-print">
			Cetak Kartu Data Pajak Air Bawah Tanah
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
...
<div id="element-box">
	...
	<div class="m">
		<form name="frm_kartu_data_restoran" id="frm_kartu_data_restoran">
			<input type="hidden" name="kodus_id" value="<?= $this->config->item('kodus_air_bawah_tanah'); ?>">
			<table class="admintable">
				<tr>
					<td class="key">Periode</td>
					<td>
						<input type="text" name="spt_periode" id="spt_periode" class="inputbox" size="4" maxlength="4" value="<?= date('Y'); ?>" onKeypress="return numbersonly(this, event)" />
					</td>
				</tr>
				<tr>
...
<script type="text/javascript">
	var GLOBAL_KARTU_DATA_AIR_TANAH_VARS = new Array();
	GLOBAL_KARTU_DATA_AIR_TANAH_VARS["cetak"] = "<?= base_url(); ?>pendataan/kartu_data/pdf_pajak_air_tanah";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/kartu_data_air_bawah_tanah.js"></script>