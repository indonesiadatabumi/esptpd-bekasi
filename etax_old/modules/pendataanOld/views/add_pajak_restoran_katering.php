<div id="toolbar-box">
	...
	<div class="m">
		...
		<div class="header icon-48-restoran">
			Isian SPTPD Pajak Restoran: <small><small id='title_head'>[ Baru ]</small></small>
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
...
<div id="element-box">
	...
	<div class="m">
		...
		$attributes = array('id' => 'frm_add_sptpd_restoran');
		$hidden = array(
			'mode' => 'add',
			'spt_jenis_pajakretribusi' => $this->config->item('jenis_pajak_restoran'),
			'kodus_id' => $this->config->item('kodus_restoran')
		);
		echo form_open('frm_add_sptpd_restoran', $attributes, $hidden);
		?>
		<div class="col width-51">
			...
			<td valign="top">
				<table class="admintable" border=0 cellspacing="1">
					...
					<?php if ($this->session->userdata('USER_SPT_CODE') == "10") {  ?>
						<tr>
					...
					<tr>
						...
						<!--
							<td>
								<input type="text" name="spt_periode_jual1" id="fDate" class="mandatory" size="11" value="<?= $tgl_pertama; ?>" />
								S / D
								<input type="text" name="spt_periode_jual2" id="tDate" class="mandatory" size="11" value="<?= $tgl_terakhir; ?>"/>
							</td>
							-->
						<td>
							<input type="text" name="spt_periode_jual1" id="" class="mandatory" size="11" value="<?= $tgl_pertama; ?>" />
							S / D
							<input type="text" name="spt_periode_jual2" id="" class="mandatory" size="11" value="<?= $tgl_terakhir; ?>" />
						</td>
					</tr>
					<tr>
						<td width="150" class="key">
						...
						<td>
							<input type="hidden" name="spt_kode_rek" value="10" id="spt_kode_rek">
							<input type="text" name="korek" id="korek" class="inputbox rekening" size="10" value="41102" readonly="true" />
							Jenis
							<input type="text" name="korek_rincian" id="korek_rincian" value="05" class="inputbox rekening" size="2" maxlength="2" />
							Klas
							<input type="text" name="korek_sub1" id="korek_sub1" value="00" class="inputbox rekening" size="2" maxlength="2" />
					...
					<tr>
						...
						<td>
							<input type="text" name="korek_nama" id="korek_nama" value="Katering" readonly="true" size="40">
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="text" name="spt_nilai" id="spt_nilai" class="inputbox" size="25" <?= $js; ?> onfocus="this.value=unformatCurrency(this.value);" onkeyup="getPajak('spt_pajak','spt_nilai','korek_persen_tarif');" onblur="getPajak('spt_pajak','spt_nilai','korek_persen_tarif');this.value=formatCurrency(this.value);" style="text-align:right;" />
					...
					<tr>
						...
						<td>
							<input type="text" name="spt_pajak" id="spt_pajak" class="inputbox" size="20" readonly="true" style="font-weight:bold;font-size:25px;color:#18F518;background-color:black;text-align:right;" />
						</td>
					</tr>
				</table>
			</td>
...
<script type="text/javascript">
	var GLOBAL_PAJAK_RESTORAN_VARS = new Array();
	GLOBAL_PAJAK_RESTORAN_VARS["get_rekening"] = "rekening/popup_rekening";
	GLOBAL_PAJAK_RESTORAN_VARS["insert_sptpd"] = "<?= base_url(); ?>pendataan/pajak_restoran/save";
	GLOBAL_PAJAK_RESTORAN_VARS["view_sptpd"] = "<?= base_url(); ?>pendataan/pajak_restoran/view";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/add_pajak_restoran.js"></script>