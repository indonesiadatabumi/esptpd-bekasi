<div id="toolbar-box">
	...
	<div class="m">
		...
		<div class="header icon-48-electric">
			Isian SPTPD PPJ PLN: <small><small id='title_head'>[ Baru ]</small></small>
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
...
<div id="element-box">
	...
	<div class="m">
		...
		$attributes = array('id' => 'frm_add_sptpd_pln');
		$hidden = array(
			'mode' => 'add',
		...
		echo form_open('frm_add_sptpd_pln', $attributes, $hidden);
		?>
				...
				<table class="admintable" border=0 cellspacing="1">
					...
					<tr>
						...
						<td>
							...
							<input type="text" name="korek" id="korek" class="inputbox rekening" value="<?= $this->config->item('korek_pln'); ?>" size="10" readonly="true" />
							Jenis
							...
							<input type="button" id="trigger_rek" size="1" value="..." class="button" />
						</td>
					</tr>
					<tr>
						<td width="150" class="key">
					...
					<tr>
						...
						<td>
							<input type="text" name="spt_pajak" id="spt_pajak" class="inputbox" size="20" <?= $js; ?> style="font-weight:bold;font-size:25px;color:#18F518;background-color:black;text-align:right;" onfocus="this.value=unformatCurrency(this.value);" onkeyup="getPengenaan('spt_pajak','spt_nilai','korek_persen_tarif');" onblur="getPengenaan('spt_pajak','spt_nilai','korek_persen_tarif');this.value=formatCurrency(this.value);" />
						</td>
					</tr>
					<tr>
...
<script type="text/javascript">
	var GLOBAL_PAJAK_PLN_VARS = new Array();
	GLOBAL_PAJAK_PLN_VARS["get_rekening"] = "rekening/popup_rekening";
	GLOBAL_PAJAK_PLN_VARS["rekening_pln"] = "rekening/find_rekening";
	GLOBAL_PAJAK_PLN_VARS["insert_sptpd"] = "<?= base_url(); ?>pendataan/pajak_pln/save";
	GLOBAL_PAJAK_PLN_VARS["view_sptpd"] = "<?= base_url(); ?>pendataan/pajak_pln/view";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/add_pajak_pln.js"></script>