<?php 
	...
	if (!empty($wp)) {
		...
		$header_type1[2]['TEXT'] = "\n<h1>KARTU DATA</h1>\n<b>PAJAK AIR TANAH</b>\n\nTahun Pajak : " . $this->input->get('spt_periode');
		$header_type1[2]['TEXT'] .= "\n\nN.P.W.P.D\n " . $wp['npwprd'] . "\n";
		...
		//$datax3[2]['T_ALIGN'] = 'C';
		//$datax3[2]['T_TYPE'] = 'B';
		$datax3[1]['BRD_TYPE'] = 'LT';
		
		$datax3[2]['TEXT'] = "Kode Rekening";
		//$datax3[3]['T_ALIGN'] = 'C';
		//$datax3[3]['T_TYPE'] = 'B';
		$datax3[2]['BRD_TYPE'] = 'LT';
		
		$datax3[3]['TEXT'] = "Jenis Air Tanah";
		$datax3[3]['BRD_TYPE'] = 'LT';		
		$datax3[4]['TEXT'] = "Persen Tarif (%)";
		$datax3[4]['BRD_TYPE'] = 'LT';		
		$datax3[5]['TEXT'] = "";
		$datax3[5]['BRD_TYPE'] = 'LR';		
		...
		$bar1[0]['TEXT'] = "B.";
		$bar1[0]['T_ALIGN'] = 'R';
		$bar1[1]['TEXT'] = "Diisi untuk Objek Air Tanah";
		$bar1[1]['COLSPAN'] = 6;
		$bar1[0]['BRD_TYPE'] = 'L';
		$bar1[1]['BRD_TYPE'] = 'R';
		$pdf->tbDrawData($bar1);
		...
		if (count($arr_spt) > 0) {
			foreach ($arr_spt as $row) {
				$q=pg_query("select setorpajret_jlh_bayar from setoran_pajak_retribusi where setorpajret_id_wp='".$row['spt_idwpwr']."' and setorpajret_spt_periode='".$row['spt_periode']."' 
							and setorpajret_jenis_pajakretribusi='".$row['spt_jenis_pajakretribusi']."' and setorpajret_no_spt='".$row['spt_nomor']."' ");
				$row1=pg_fetch_assoc($q);
				$dat[0]['TEXT'] = "";
				$dat[0]['BRD_TYPE'] = 'L';
				$dat[1]['TEXT'] = "" . $counter . ".";
				$dat[1]['T_ALIGN'] = 'R';
				...
				$dat[4]['T_ALIGN'] = 'R';
				$dat[4]['BRD_TYPE'] = 'LT'; 
				$dat[5]['TEXT'] = "" . format_currency($row1['setorpajret_jlh_bayar']);
				$dat[5]['T_ALIGN'] = 'R';
				$dat[5]['BRD_TYPE'] = 'LT';
				$dat[6]['TEXT'] = "";
				$dat[6]['BRD_TYPE'] = 'LR';
				...
				$jumlah_setoran += $row1['setorpajret_jlh_bayar'];
