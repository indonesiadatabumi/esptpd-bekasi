<div id="toolbar-box">
	...
	<div class="m">
		...
		<div class="header icon-48-electric">
			Isian SPTPD PPJ / Genset: <small><small id='title_head'>[ Edit ]</small></small>
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
...
<div id="element-box">
	...
	<div class="m">
		...
		$attributes = array('id' => 'frm_edit_sptpd_genset');
		$hidden = array(
			'mode' => 'add',
		...
		echo form_open('frm_edit_sptpd_genset', $attributes, $hidden);
		?>
...
<script type="text/javascript">
	...
	GLOBAL_PAJAK_GENSET_VARS["update_sptpd"] = "<?= base_url(); ?>pendataan/pajak_genset/update";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/edit_pajak_genset.js"></script>