...
<script type="text/javascript">
	function showFormKartuData(idRefJenisPajak) {
		...
		if (idRefJenisPajak == "1")
			load_content("<?= base_url(); ?>pendataan/kartu_data/pajak_hotel");
		else if (idRefJenisPajak == "2")
			load_content("<?= base_url(); ?>pendataan/kartu_data/pajak_restoran");
		else if (idRefJenisPajak == "3")
			load_content("<?= base_url(); ?>pendataan/kartu_data/pajak_hiburan");
		else if (idRefJenisPajak == "4")
			load_content("<?= base_url(); ?>pendataan/kartu_data/pajak_reklame");
		else if (idRefJenisPajak == "5")
			load_content("<?= base_url(); ?>pendataan/kartu_data/pajak_genset");
		else if (idRefJenisPajak == "6")
			load_content("<?= base_url(); ?>pendataan/kartu_data/pajak_pln");
		else if (idRefJenisPajak == "7")
			load_content("<?= base_url(); ?>pendataan/kartu_data/pajak_parkir");
		else if (idRefJenisPajak == "8")
			load_content("<?= base_url(); ?>pendataan/kartu_data/pajak_air_bawah_tanah");
		else if (idRefJenisPajak == "9")
			load_content("<?= base_url(); ?>pendataan/kartu_data/pajak_sarang_walet");
	};
