<?php 
	...
	if (!empty($wp)) {
		...
		$data_tarif[3]['TEXT'] = "Meja yang tersedia";
		$data_tarif[3]['T_ALIGN'] = 'C';
		$data_tarif[3]['BRD_TYPE'] = 'LT';
		
		$data_tarif[4]['TEXT'] = "Jumlah Kursi";
		$data_tarif[4]['T_ALIGN'] = 'C';
		$data_tarif[4]['BRD_TYPE'] = 'LT';
		
		$data_tarif[5]['TEXT'] = "Jumlah pengunjung rata-rata perhari";
		...
		$bar1[0]['TEXT'] = "B.";
		$bar1[0]['T_ALIGN'] = 'R';
		$bar1[1]['TEXT'] = "Diisi untuk Objek Restoran";
		$bar1[1]['COLSPAN'] = 6;
		$bar1[0]['BRD_TYPE'] = 'L';
		$bar1[1]['BRD_TYPE'] = 'R';
		$pdf->tbDrawData($bar1);
		...
		$bar4[0]['TEXT'] = "";
		$bar4[0]['BRD_TYPE'] = 'L';
		$bar4[1]['TEXT'] = "\nB.2. Jumlah pembayaran dan setoran yang dilakukan";
		$bar4[1]['COLSPAN'] = 6;
		$bar4[1]['BRD_TYPE'] = 'R';
		$pdf->tbDrawData($bar4);	
		$pdf->tbOuputData();
