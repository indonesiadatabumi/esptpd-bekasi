<div id="toolbar-box">
	...
	<div class="m">
		...
		<div class="header icon-48-hotel">
			Isian SPTPD Pajak Hotel: <small><small id='title_head'>[ Baru ]</small></small>
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
				...
				<table class="admintable" border=0 cellspacing="1">
					...
					<tr>
						...
						<td>
							...
							<input type="text" name="korek" id="korek" class="inputbox rekening" value="<?= $this->config->item('korek_hotel'); ?>" size="10" readonly="true" />
							Jenis
...
<script type="text/javascript">
	var GLOBAL_PAJAK_HOTEL_VARS = new Array();
	GLOBAL_PAJAK_HOTEL_VARS["get_rekening"] = "rekening/popup_rekening";
	GLOBAL_PAJAK_HOTEL_VARS["insert_sptpd"] = "<?= base_url(); ?>pendataan/pajak_hotel/save";
	GLOBAL_PAJAK_HOTEL_VARS["view_sptpd"] = "<?= base_url(); ?>pendataan/pajak_hotel/view";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/add_pajak_hotel.js"></script>