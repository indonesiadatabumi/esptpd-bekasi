...
var completePage = function() {	
	...
	$("#trigger_rek").click(function() {
		showDialog(GLOBAL_PAJAK_HOTEL_VARS["get_rekening"]+"?koderek=" + $("#korek").val(), 'Kode Rekening', 800, 500);
	});
...
var createEventToolbar = function() {
	var submitForm = function() {
		...
		var save_options = { 
			url : GLOBAL_PAJAK_HOTEL_VARS["insert_sptpd"],
			type : "POST",
			dataType: 'json',
		...
		$("#frm_add_sptpd_hotel").ajaxSubmit(save_options);
	};
	...
	$("#btn_view").click(function() {
		//load content panel
		load_content(GLOBAL_PAJAK_HOTEL_VARS["view_sptpd"]);
	});
};
