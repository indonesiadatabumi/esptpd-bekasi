		...
		<div class="col-lg-12">
			<div class="main-card mb-6 card">
				<div id="toolbar-box">
					...
					<div class="m">
						<div class="header icon-48-user"> Cetak Laporan Pendapatan Pajak Daerah </div>
						<div class="clr"></div>
					</div>
					<div class="b">
						<div class="b">
	...
	<script type="text/javascript">
		...
		GLOBAL_REALISASI_PAJAK_VARS["cetak"] = "<?= base_url(); ?>pembukuan/pendapatan_pajak_daerah/save_excel";
	</script>
	<script type="text/javascript" src="<?= base_url(); ?>modules/pembukuan/scripts/form_pendapatan_pajak_daerah.js"></script>