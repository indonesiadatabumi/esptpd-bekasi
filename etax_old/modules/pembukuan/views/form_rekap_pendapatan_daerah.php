...
<script type="text/javascript">
    var GLOBAL_REKAP_PENDAPATAN_VARS = new Array();
    GLOBAL_REKAP_PENDAPATAN_VARS["cetak"] = "<?= base_url(); ?>pembukuan/rekap_pendapatan_daerah/save_excel";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pembukuan/scripts/form_rekap_pendapatan_daerah.js"></script>