	...
	<div class="col width-51">
			...
			<table class="admintable" border=0 cellspacing="1">
                                <tr>
                                      ...
                                      <td> 
                                          <input type="text" name="thn_pajak" id="thn_pajak" class="inputbox mandatory" size="5" maxlength="4" value="<?=date('Y');?>" onKeypress = "return numbersonly(this, event)" />
                                      </td>
                                </tr>
				...
				<tr>
					<td width="150" class="key">
						<label for="name"> Nomor Wajib Pajak </label>
					</td>      
					<td>    
...
<script type="text/javascript">
	...
	GLOBAL_CETAK_BUKU_VARS["cetak"] = "<?=base_url();?>pembukuan/buku_wp/cetak";
</script>
<script type="text/javascript" src="<?=base_url();?>modules/pembukuan/scripts/form_buku_wp.js"></script>