                                                        ...
                                                        <TD valign="top">
                                                            <table class="admintable" border=0 cellspacing="1">
                                                                ...
                                                                <tr id="jenis_restoran2" style="display: none;">
                                                                    ...
                                                                    <td>
                                                                        <?php
                                                                        $attributes = 'id="jenis_pajak_restoran2" class="inputbox"';
                                                                        echo form_dropdown('jenis_pajak_restoran2', $jenis_pajak_restoran, '', $attributes);
                                                                        ?>
                                                                    </td>
                                                                </tr>
                                                                <tr>
...
<script type="text/javascript" src="<?= base_url(); ?>modules/pembukuan/scripts/form_buku_kendali.js"></script>