...
<script type="text/javascript">
	...
	GLOBAL_VIEW_SETORAN_VARS["get_list"] = "<?= base_url(); ?>bkp/rekam_pajak/get_list_setoran_bank";
	GLOBAL_VIEW_SETORAN_VARS["back"] = "<?= base_url(); ?>bkp/rekam_pajak/setor_pajak";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/bkp/scripts/view_setoran_pajak_bank.js"></script>