			...
			<table class="toolbar">
				<tr>
				    <td class="button" id="toolbar-ref">
						<a href="#" id="btn_view2" class="toolbar">
							<span class="icon-32-ref" title="Pembayaran Bank"></span>Pembayaran Bank
						</a>
					</td>
					<td class="button" id="toolbar-ref">
...
<script type="text/javascript">
	...
	GLOBAL_SETOR_PAJAK_VARS["view_setoran_bank"] = "<?= base_url(); ?>bkp/rekam_pajak/view_setoran_bank";
	GLOBAL_SETOR_PAJAK_VARS["batal_setoran"] = "<?= base_url(); ?>bkp/setoran_batal/";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/bkp/scripts/form_rekam_setoran_pajak.js"></script>