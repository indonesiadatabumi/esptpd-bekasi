...
<script type="text/javascript">
	...
	GLOBAL_BATAL_SETORAN_VARS["get_list"] = "<?= base_url(); ?>bkp/setoran_batal/get_list";
	GLOBAL_BATAL_SETORAN_VARS["insert"] = "<?= base_url(); ?>bkp/setoran_batal/insert";
	GLOBAL_BATAL_SETORAN_VARS["back"] = "<?= base_url(); ?>bkp/rekam_pajak/setor_pajak";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/bkp/scripts/form_batal_setoran.js"></script>