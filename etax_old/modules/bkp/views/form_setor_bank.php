		...
		<table width="60%" border="0">
			<tr>
				<td align="RIGHT">
					...
					&nbsp;&nbsp;&nbsp;
					<input type="text" name="txt_total_setor" id="txt_total_setor" class="inputbox" size="20" value="" readonly="true" style="font-weight: bold; font-size: 15px; color: #18F518; background-color: black; text-align: right;" />
				</td>
			</tr>
		</table>
		<?php
...
<script type="text/javascript" src="<?= base_url(); ?>modules/bkp/scripts/form_setor_bank.js"></script>