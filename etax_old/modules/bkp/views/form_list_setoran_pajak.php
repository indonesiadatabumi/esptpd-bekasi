...
?>
							...
							<tr>
								<td>
									<table border=0 cellspacing="1" width="100%">
										<?php
										if (
											$v['koderek_detail'] == '4.1.1.08.01' || $v['koderek_detail'] == '4.1.1.04.01' || $v['koderek_detail'] == '4.1.1.04.02' || $v['koderek_detail'] == '4.1.1.04.03' || $v['koderek_detail'] == '4.1.1.04.04' || $v['koderek_detail'] == '4.1.1.04.05' || $v['koderek_detail'] == '4.1.1.04.06'
											...
											<tr>
												...
												<td>
													<select name="jenis_setoran">
														<option value="2">Pokok Pajak </option>
														<select>
												</td>
											</tr>
										<?php } else { ?>
										...
										if ($tgl_setoran == 05) {
											$diskon = $total * 0.15;
										} else if ($tgl_setoran == 06) {
											$diskon = $total * 0.10;
										} else if ($tgl_setoran == 07 || $tgl_setoran == 08) {
											$diskon = $total * 0.05;
										}
										...
										<tr>
											...
											<td>
												...
												<input type="text" name="txt_setoran" id="txt_setoran" value="<?= format_currency($total_setoran); ?>" class="inputbox" style="font-weight: bold; text-align: right;" size="17" maxlength="40" readonly="true" />
											</td>
										</tr>
										<tr>
											<td colspan="2" align="center">
												<input type="button" id="btn_setor" title="Lakukan Penyetoran" value="Simpan Setoran" class="button" style="padding: 5px 3px 5px 3px;letter-spacing: 1px;">
											</td>
										</tr>
									</table>
								</td>
	...
	<script type="text/javascript" src="<?= base_url(); ?>modules/bkp/scripts/form_list_setoran_pajak.js"></script>
