										...
										<table class="admintable" border=0 cellspacing="1">
															...
															<tbody id="tbody_detail">
																...
																?>
																		<tr class="row0" id="row_detail<?= $counter ?>">
																			...
																			<td>
																				<input type="text" name="txt_dt_setoran[]" id="txt_dt_setoran<?= $counter ?>" value="<?= format_currency($dt->sld_jlh_setor) ?>" class="inputbox mandatory" size="16" style="font-weight: bold; font-size: 10px; text-align:right;" onblur="this.value=formatCurrency(this.value);" onfocus="this.value=unformatCurrency(this.value);" onKeypress="return numbersonly(this, event)" />
																			</td>
																			<td>
											...
											<tr>
												<td align="center">
													...
													&nbsp;&nbsp;&nbsp; TOTAL &nbsp;&nbsp;&nbsp;
													<input type="text" name="txt_setoran" id="txt_setoran" class="inputbox" size="20" value="<?= format_currency($header->slh_jumlah); ?>" readonly="true" style="font-weight:bold;font-size:25px;color:#18F518;background-color:black;text-align:right;" />
												</td>
											</tr>
										</table>
									</fieldset>
...
<script type="text/javascript" src="<?= base_url(); ?>modules/bkp/scripts/edit_setoran_dinas.js"></script>