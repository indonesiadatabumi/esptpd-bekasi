										...
										<table class="admintable" border=0 cellspacing="1">
											...
											<tr>
												<td align="center">
													...
													&nbsp;&nbsp;&nbsp; TOTAL &nbsp;&nbsp;&nbsp;
													<input type="text" name="txt_setoran" id="txt_setoran" class="inputbox" size="20" value="" readonly="true" style="font-weight:bold;font-size:25px;color:#18F518;background-color:black;text-align:right;" />
												</td>
											</tr>
										</table>
									</fieldset>
...
<script type="text/javascript" src="<?= base_url(); ?>modules/bkp/scripts/form_setoran_dinas.js"></script>