			...
			<table class="toolbar">
				<tr>
					<td class="button" id="toolbar-new">
						<a href="#" id="btn_print">
							<span class="icon-32-print" title="Cetak Surat Tanda Setoran ke Bank"> </span> Cetak STS
						</a>
					</td>
					<td class="button" id="toolbar-ref">
						<a href="#" id="btn_save">
							<span class="icon-32-save" title="SIMPAN Surat Setoran ke Bank"> </span> Simpan
						</a>
					</td>
					<td class="button" id="toolbar-ref">
						<a href="#" id="btn_reset">
							<span class="icon-32-reload" title="Kembalikan Data ke Posisi Awal"> </span> Reset
						</a>
					</td>
				</tr>
			</table>
	...
	<div class="m">
		...
		<table class="admintable" cellspacing="3" style="font-size: 12px;">
			...
			<tr>
				...
				<td>
					<input type="text" name="txt_dari" id="txt_dari" size="50" class="inputbox mandatory" /> *
				</td>
			</tr>
			<tr>
				<td width="10%" class="key">Alamat</td>
				<td>
					<input type="text" name="txt_alamat" id="txt_alamat" class="inputbox mandatory" size="80" /> *
				</td>
			</tr>
			<tr>
				<td width="10%" class="key">Keterangan</td>
				<td>
		...
		<table width="60%" border="0">
			<tr>
				<td align="RIGHT">
					<input type="BUTTON" value="TAMBAH DETAIL" id="btn_add_detail"> &nbsp;&nbsp;&nbsp; TOTAL
					&nbsp;&nbsp;&nbsp;
					<input type="text" name="totalSetorBank" id="totalSetorBank" class="inputbox" size="20" value="" readonly="true" style="font-weight: bold; font-size: 15px; color: #18F518; background-color: black; text-align: right;" />
				</td>
			</tr>
		</table>
		<?php
...
<script type="text/javascript" src="<?= base_url(); ?>modules/bkp/scripts/add_setor_bank.js"></script>