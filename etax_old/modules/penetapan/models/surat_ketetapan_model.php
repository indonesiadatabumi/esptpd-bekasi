...
class Surat_ketetapan_model extends CI_Model {
	...
	function daftar_surat_ketetapan_reklame() {
		...
		$sql = "SELECT a.*, b.korek_nama as korek_nama_detail,b.spt_dt_pajak, c.sptrek_judul, c.sptrek_lokasi
	...
	function daftar_tanggal_surat_ketetapan_reklame() {
		...
		$sql = "SELECT a.*, b.korek_nama as korek_nama_detail, b.spt_dt_pajak, c.sptrek_judul, d.sptrek_lokasi
					FROM v_daftar_ketetapan_list a 
					INNER JOIN v_spt_detail b ON a.netapajrek_id_spt=b.spt_dt_id_spt
					LEFT JOIN spt_reklame c ON b.spt_dt_id=c.sptrek_id_spt_dt 
					LEFT JOIN spt_reklame d ON b.spt_dt_id=d.sptrek_id_spt_dt $where $order_by";
		//echo $sql;
		$result = $this->adodb->GetAll($sql);
		return $result;
	}
