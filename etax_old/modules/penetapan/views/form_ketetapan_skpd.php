...
<div id="element-box">
	...
	<div class="m">
		...
		$hidden = array('mode' => 'add', 'jenis_ketetapan' => $this->config->item('status_skpd'));
		...
		<div class="col width-51">
			<table class="admintable" border=0 cellspacing="1">
				...
				<tr>
					...
					<td>
						<input type="text" name="no_kohir1" id="no_kohir1" class="inputbox mandatory" size="8" />
						<input type="button" id="trigger_spt1" size="2" value="..." class="button" />
						s/d
						<input type="text" name="no_kohir2" id="no_kohir2" class="inputbox mandatory" size="8" />
...
<script type="text/javascript">
	var GLOBAL_KET_SKPD_VARS = new Array();
	GLOBAL_KET_SKPD_VARS["get_spt"] = "penetapan/surat_ketetapan/get_penetapan";
	GLOBAL_KET_SKPD_VARS["cetak"] = "<?= base_url(); ?>penetapan/surat_ketetapan/pdf_skpd";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/penetapan/scripts/form_ketetapan_skpd.js"></script>