...
$pdf->Open();
$pdf->SetFont('Arial','',8);
$pdf->SetAutoPageBreak(true, 1); // Page Break dengan margin bawah 1 cm
...
if (!empty($data_id)) {	
	foreach ($data_id as $k => $v) {		
		...
		$spacer1[0]['WIDTH'] = 15;$spacer1[1]['WIDTH'] = 50;$spacer1[2]['WIDTH'] = 2;$spacer1[3]['WIDTH'] = 90;$spacer1[4]['WIDTH'] = 3;$spacer1[5]['WIDTH'] = 30;
		...
		$pdf->tbSetTableType($table_default_header_type);
				
		for($j=0;$j<$cols;$j++) $colw[$j] = $table_default_header_type;
		
		for($j=0;$j<$cols;$j++) {
			$cwid[$j] = $table_default_header_type;
		}
		$cwid[0]['WIDTH'] = 5;$cwid[1]['WIDTH'] = 185;
		$pdf->tbSetHeaderType($cwid);
		
		for($k=0;$k<$cols;$k++) {
			$ins[$k] = $table_default_headerx_type;
			$ket[$k] = $table_default_headerx_type;
		}
		...
		$ket[0]['TEXT'] = "";$ket[1]['TEXT'] = "<h2>".strtoupper($data[0] ['lhp_catatan'])."</h2>";
		...
		$tbd[3]['TEXT'] = "".$data[0]['wp_wr_almt']." KEL. ".$data[0]['wp_wr_lurah']." KEC. ".$data[0]['wp_wr_camat'];
		...
		$dt2[4]['TEXT'] = "Rp.";
		$dt2[4]['T_ALIGN'] = 'R';
		$dt2[5]['TEXT'] = format_currency($lhp_dt_kompensasi);
		$dt2[5]['T_ALIGN'] = 'R';
		$dt2[6]['TEXT'] = "";
		$dt2[7]['TEXT'] = "";
		$dt2[8]['TEXT'] = "";
		...
		$dt2[4]['TEXT'] = "Rp.";
		$dt2[4]['T_ALIGN'] = 'R';
		$dt2[5]['TEXT'] = format_currency($lhp_dt_setoran);
		$dt2[5]['T_ALIGN'] = 'R';
		$dt2[6]['TEXT'] = "";
		$dt2[7]['TEXT'] = "";
		$dt2[8]['TEXT'] = "";
		...
		$kurang_bayar = $lhp_dt_pajak - $total_kredit;
		$dt4[0]['TEXT'] = "";
		$dt4[0]['BRD_TYPE'] = 'L';
		$dt4[1]['TEXT'] = "";
		$dt4[2]['TEXT'] = "4.";
		$dt4[3]['TEXT'] = "Jumlah kekurangan pembayaran Pokok Pajak (2-3d)";
		$dt4[4]['TEXT'] = "";
		$dt4[5]['TEXT'] = "";
		$dt4[6]['TEXT'] = "Rp.";
		$dt4[6]['T_ALIGN'] = 'R';
		$dt4[6]['BRD_TYPE'] = 'T';
		$dt4[7]['TEXT'] = format_currency($kurang_bayar);
		$dt4[7]['T_ALIGN'] = 'R';
		$dt4[7]['BRD_TYPE'] = 'T';
		$dt4[8]['TEXT'] = "";
		$dt4[8]['BRD_TYPE'] = 'R';
		...
		$dt2[1]['TEXT'] = "";
		$dt2[2]['TEXT'] = "";
		$dt2[3]['TEXT'] = "a. Bunga (Psl. 97(2))";
		$dt2[4]['TEXT'] = "Rp.";
		$dt2[4]['T_ALIGN'] = 'R';
		$dt2[5]['TEXT'] = format_currency($lhp_dt_bunga);
		$dt2[5]['T_ALIGN'] = 'R';
		$dt2[6]['TEXT'] = "";
		$dt2[7]['TEXT'] = "";
		$dt2[8]['TEXT'] = "";
		...
		$dt2[1]['TEXT'] = "";
		$dt2[2]['TEXT'] = "";
		$dt2[3]['TEXT'] = "b. Kenaikan (Psl. 97(3))";
		$dt2[4]['TEXT'] = "Rp.";
		$dt2[4]['T_ALIGN'] = 'R';
		$dt2[5]['TEXT'] = format_currency($lhp_dt_kenaikan);
		$dt2[5]['T_ALIGN'] = 'R';
		$dt2[6]['TEXT'] = "";
		$dt2[7]['TEXT'] = "";
		$dt2[8]['TEXT'] = "";
		...
		$dt3[6]['TEXT'] = "Rp.";
		$dt3[6]['T_ALIGN'] = 'R';
		$dt3[7]['TEXT'] = format_currency($total_sanksi);
		$dt3[7]['T_ALIGN'] = 'R';
		$dt3[8]['TEXT'] = "";
		$dt3[8]['BRD_TYPE'] = 'R';
		$pdf->tbDrawData($dt3);
		
		$total_pajak = $data[0]['lhp_pajak'];
		$dt4[0]['TEXT'] = "";
		$dt4[0]['BRD_TYPE'] = 'L';
		$dt4[1]['TEXT'] = "";
		$dt4[2]['TEXT'] = "6.";
		...
		$ket[0]['TEXT'] = "1.";
		$ket[1]['TEXT'] = "Harap penyetoran dilakukan melalui Bendahara Penerimaan atau Kas Daerah dengan menggunakan Surat Setoran Pajak Daerah (SSPD).";
		$ket[0]['BRD_TYPE'] = 'L';
		$ket[1]['BRD_TYPE'] = 'R';
		$ket[0]['V_ALIGN'] = 'T';
		$ket[0]['T_ALIGN'] = 'R';
		...
		$ket[0]['TEXT'] = "2.";
		$ket[1]['TEXT'] = "Apabila ".$s_title." ini tidak atau Kurang Dibayar setelah lewat waktu paling lama 30 hari  sejak  ".$s_title." ini ditetapkan dikenakan sanksi administrasi berupa bunga sebesar 2%  per bulan.\n\n";
		$pdf->tbDrawData($ket);
		...
		$tnd[0]['TEXT'] = "";
		$tnd[1]['TEXT'] = strtoupper($pemda->dapemda_ibu_kota).", ".strtoupper(format_tgl($tglx,false,true));
		$tnd[0]['BRD_TYPE'] = 'L';
		$tnd[1]['BRD_TYPE'] = 'R';
		$pdf->tbDrawData($tnd);
		...
		$dt2[3]['TEXT'] = "".$data[0]['wp_wr_almt']." KEL. ".$data[0]['wp_wr_lurah']." KEC. ".$data[0]['wp_wr_camat'];
		$dt2[4]['TEXT'] = "";
		$dt2[5]['TEXT'] = "";
		$dt2[5]['BRD_TYPE'] = 'R';		
		$pdf->tbDrawData($dt2);
