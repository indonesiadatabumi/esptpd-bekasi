...
<script type="text/javascript">
	...
	GLOBAL_FORM_STPD_VARS["get_spt"] = "<?= base_url(); ?>penetapan/stpd/get_spt";
	GLOBAL_FORM_STPD_VARS["insert"] = "<?= base_url(); ?>penetapan/stpd/insert";
	GLOBAL_FORM_STPD_VARS["view"] = "<?= base_url(); ?>penetapan/stpd";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/penetapan/scripts/form_stpd.js"></script>