...
<div id="element-box">
	...
	<div class="m">
		...
		$hidden = array('mode' => 'add', 'jenis_ketetapan' => $this->config->item('status_skpdt'));
...
<script type="text/javascript">
	var GLOBAL_KET_SKPDT_VARS = new Array();
	GLOBAL_KET_SKPDT_VARS["get_spt"] = "penetapan/surat_ketetapan/get_penetapan";
	GLOBAL_KET_SKPDT_VARS["cetak"] = "<?= base_url(); ?>penetapan/surat_ketetapan/pdf_skpdt";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/penetapan/scripts/form_ketetapan_skpdt.js"></script>