...
<div id="element-box">
	...
	<div class="m">
		...
		$hidden = array('mode' => 'add', 'jenis_ketetapan' => $this->config->item('status_skpdn'));
...
<script type="text/javascript">
	var GLOBAL_KET_SKPDKB_VARS = new Array();
	GLOBAL_KET_SKPDKB_VARS["get_spt"] = "penetapan/surat_ketetapan/get_penetapan";
	GLOBAL_KET_SKPDKB_VARS["cetak"] = "<?= base_url(); ?>penetapan/surat_ketetapan/pdf_skpdn";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/penetapan/scripts/form_ketetapan_skpdn.js"></script>