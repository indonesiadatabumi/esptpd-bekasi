...
if (!empty($ar_npwpd)) 
{
	foreach ($ar_npwpd as $k1 => $v1) {
		...
		$dt[2]['TEXT'] .= "\n<th1>PPAJAK REKLAME</th1>";
		$dt[2]['TEXT'] .= "\n<p>MMASA PAJAK : ".strtoupper($mspjk_bln)."     TAHUN : ".$mspjk_thn."</p>";
		...
		$dt1[2]['TEXT'] = "ALAMAT : " . $_data_sptpd[0]['wp_wr_almt'];
	    ...
	    $pdf->MultiCell(190,3,$pdf->SetFont('Arial','',6).$pdf->Cell(15,2,'Reklame Rokok','','','L').$pdf->Cell(125,2,':  Nilai KJ x Ukuran x Jumlah x Jangka Waktu x 25% + 50%','','','C').$pdf->Cell(80,2,'','','','L'),'','','',2);
	    $pdf->MultiCell(190,3,$pdf->SetFont('Arial','',6).$pdf->Cell(15,2,'Tambah Ketinggian','','','L').$pdf->Cell(125,2,':  Nilai KJ x Ukuran x Jumlah x Jangka Waktu x 25% + 20%','','','C').$pdf->Cell(80,2,'','','','L'),'','','',2);
		$pdf->MultiCell(190,3,$pdf->SetFont('Arial','',6).$pdf->Cell(15,2,'','','','L').$pdf->Cell(3,2,'','','','C').$pdf->Cell(80,2,'','','','L'),'','','',2);
