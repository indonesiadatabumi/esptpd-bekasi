...
<div id="element-box">
	...
	<div class="m">
		...
		$hidden = array('mode' => 'add', 'jenis_ketetapan' => $this->config->item('status_skpdlb'));
...
<script type="text/javascript">
	var GLOBAL_KET_SKPDLB_VARS = new Array();
	GLOBAL_KET_SKPDLB_VARS["get_spt"] = "penetapan/surat_ketetapan/get_penetapan";
	GLOBAL_KET_SKPDLB_VARS["cetak"] = "<?= base_url(); ?>penetapan/surat_ketetapan/pdf_skpdlb";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/penetapan/scripts/form_ketetapan_skpdlb.js"></script>