...
<script type="text/javascript">
	...
	GLOBAL_KET_STPD_VARS["get_spt"] = "<?= base_url(); ?>penetapan/surat_ketetapan/get_penetapan";
	GLOBAL_KET_STPD_VARS["cetak"] = "<?= base_url(); ?>penetapan/surat_ketetapan/pdf_stpd";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/penetapan/scripts/form_ketetapan_stpd.js"></script>