...
if ($_GET['spt_jenis_pajakretribusi'] == '8') {
	...
	$jdl[1]['TEXT'] = "Masa Pajak : ".getNamaBulan($arr_masa_pajak[1])." ".$arr_masa_pajak[0];
} else {
	$masa_pajak = $data[0]['spt_periode_jual1'];
	$arr_masa_pajak = explode('-', $masa_pajak);
	
	$jdl[0]['TEXT'] = "Jenis Pajak   : ".strtoupper($jenis_pajak);
	$jdl[1]['TEXT'] = "Bulan Ketetapan: ".getNamaBulan($_GET['bulan'])." ".$_GET['tahun'];
}
$pdf->tbDrawData($jdl);
