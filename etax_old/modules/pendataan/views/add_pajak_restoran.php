						...
						<table class="admintable">
							<tr>
								...
								<td>
									...
									<input type="text" name="spt_no_register" id="spt_no_register" class="inputbox mandatory" <?= $js; ?> size="10" maxlength="15" readonly />
				...
				<table class="admintable" border=0 cellspacing="1">
					...
					<tr>
						...
						<td>
							...
							<input type="text" name="korek" id="korek" class="inputbox rekening" size="10" value="<?= $this->config->item('korek_restoran'); ?>" readonly="true" />
							Jenis
					...
					<tr>
						...
						<td>
							<input type="text" name="korek_nama" id="korek_nama" class="mandatory" readonly="true" size="40">
						</td>
					</tr>
					<tr>
