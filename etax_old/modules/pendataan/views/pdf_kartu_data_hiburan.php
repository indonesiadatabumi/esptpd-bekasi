...
// html2pdf
// require APPPATH . 'libraries/fpdf/html2pdf.php';
...
if (!empty($wp)) {
	...
	// test
	// $pdf->MultiCell(190,5,$pdf->SetFont('Arial','B',7).
	// $pdf->Cell(12,3,"",'','','C').
	// $header_type1[2]['TEXT'] = $pdf->SetFont('Arial','B',14).$pdf->Cell(180,3,"KARTU DATA",'','','C'),'','','',0);

	// $pdf->MultiCell(190,6,$pdf->SetFont('Arial','B',7).
	// $pdf->Cell(12,3,"",'','','C').
	// $header_type1[2]['TEXT'] = $pdf->SetFont('Arial','B',12).$pdf->Cell(180,3,"PAJAK HIBURAN",'','','C'),'','','',0);

	// $pdf->MultiCell(190,6,$pdf->SetFont('Arial','B',7).
	// $pdf->Cell(12,3,"",'','','C').
	// $header_type1[2]['TEXT'] = $pdf->SetFont('Arial','',10).$pdf->Cell(180,3,"Tahun Pajak : ". $this->input->get('spt_periode'),'','','C'),'','','',0);

	// $pdf->MultiCell(190,5,$pdf->SetFont('Arial','B',7).
	// $pdf->Cell(12,3,"",'','','C').
	// $header_type1[2]['TEXT'] = $pdf->SetFont('Arial','',10).$pdf->Cell(180,3,"N.P.W.P.D  \n" . $wp['npwprd'],'','','C'),'','','',0);
	...
	// $pdf->Cell(190,7,'PAJAK HIBURAN',0,1,'C');
	...
	$datax1[1]['COLSPAN'] = 6;
	$datax1[1]['BRD_TYPE'] = 'R';
	$datax1[1]['TEXT'] = "Objek Pertunjukan Film";
	...
	$datax2[1]['TEXT'] = "A.1.";
	$datax2[2]['COLSPAN'] = 2;
	$datax2[2]['TEXT'] = "Golongan Bioskop  :";
	$datax2[4]['COLSPAN'] = 2;
	$datax2[4]['TEXT'] = "[   ]  A.I            [   ]  C";
	$datax2[6]['BRD_TYPE'] = 'R';
	...
	$datax3[0]['TEXT'] = "";
	$datax3[1]['TEXT'] = "A.2.";
	$datax3[2]['TEXT'] = "Harga Tanda Masuk";
	$datax3[2]['COLSPAN'] = 4;
	$datax3[6]['TEXT'] = "";
	$datax3[6]['BRD_TYPE'] = 'R';
	...
	$datax3[0]['TEXT'] = "";
	$datax3[1]['TEXT'] = "A.3.";
	$datax3[2]['TEXT'] = "Jumlah pertunjukan dan pengunjung rata-rata";
	$datax3[2]['COLSPAN'] = 4;
	$datax3[6]['TEXT'] = "";
	$datax3[6]['BRD_TYPE'] = 'R';
	$pdf->tbDrawData($datax3);
	...
	$data_tarif[4]['TEXT'] = "Jumlah Pertunjukan";
	$data_tarif[4]['T_ALIGN'] = 'C';
	$data_tarif[4]['BRD_TYPE'] = 'LT';

	$data_tarif[5]['TEXT'] = "Jumlah Pengunjung";
	$data_tarif[5]['T_ALIGN'] = 'C';
	$data_tarif[5]['BRD_TYPE'] = 'LT';
	...
	$bar1[0]['TEXT'] = "B.";
	$bar1[0]['T_ALIGN'] = 'R';
	$bar1[1]['TEXT'] = "Diisi untuk Objek pertunjukan film";
	$bar1[1]['COLSPAN'] = 6;
	$bar1[0]['BRD_TYPE'] = 'L';
	$bar1[1]['BRD_TYPE'] = 'R';
	$pdf->tbDrawData($bar1);
	...
	$bar2[0]['TEXT'] = "";
	$bar2[0]['BRD_TYPE'] = 'L';
	$bar2[1]['TEXT'] = "b.1. Menggunakan Kas Register";
	$bar2[1]['COLSPAN'] = 3;
	$bar2[4]['TEXT'] = "[   ]  1. Ya";
	$bar2[4]['COLSPAN'] = 3;
	$bar2[4]['BRD_TYPE'] = 'R';
	...
	$bar4[0]['TEXT'] = "";
	$bar4[0]['BRD_TYPE'] = 'L';
	$bar4[1]['TEXT'] = "B.2. Jumlah pembayaran dan setoran yang dilakukan";
	$bar4[1]['COLSPAN'] = 6;
	$bar4[1]['BRD_TYPE'] = 'R';
	$pdf->tbDrawData($bar4);
	$pdf->tbOuputData();
