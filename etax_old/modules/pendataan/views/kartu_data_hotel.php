...
<div id="element-box">
	...
	<div class="m">
		<form name="frm_kartu_data_hotel" id="frm_kartu_data_hotel">
			<input type="hidden" name="kodus_id" value="<?= $this->config->item('kodus_hotel'); ?>">
...
<script type="text/javascript">
	var GLOBAL_KARTU_DATA_HOTEL_VARS = new Array();
	GLOBAL_KARTU_DATA_HOTEL_VARS["cetak"] = "<?= base_url(); ?>pendataan/kartu_data/pdf_pajak_hotel";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/kartu_data_hotel.js"></script>