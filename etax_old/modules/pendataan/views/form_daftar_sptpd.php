					...
					<table class="admintable">
						...
						<tr>
							...
							<td>
								...
								<input type="button" name="btn_cetak_entry" id="btn_cetak_entry" value=" Cetak PDF " class="button" />
								&nbsp;&nbsp;&nbsp;
								<?php
								if ($this->session->userdata('USER_SPT_CODE') == "10") {
								?>
									<input type="button" name="btn_cetak_entry_xls" id="btn_cetak_entry_xls" value=" Cetak Excel " class="button" />
								<?php
								}
								?>
...
<script type="text/javascript">
	...
	GLOBAL_SPTPD_VARS["cetak_via_tgl_entry_xls"] = "<?= base_url(); ?>pendataan/sptpd/cetak_xls_daftar_sptpd_entry";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/form_daftar_sptpd.js"></script>