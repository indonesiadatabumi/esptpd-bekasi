<div id="toolbar-box">
	...
	<div class="m">
		<div class="header icon-48-print">
			Cetak Kartu Data Pajak Restoran
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
...
<div id="element-box">
	...
	<div class="m">
		<form name="frm_kartu_data_restoran" id="frm_kartu_data_restoran">
			<input type="hidden" name="kodus_id" value="<?= $this->config->item('kodus_restoran'); ?>">
			<table class="admintable">
				<tr>
					<td class="key">Periode</td>
					<td>
						<input type="text" name="spt_periode" id="spt_periode" class="inputbox mandatory" size="4" maxlength="4" value="<?= date('Y'); ?>" onKeypress="return numbersonly(this, event)" />
					</td>
				</tr>
				<tr>
					<td class="key">N.P.W.P.D</td>
					<td>
						<input type="hidden" name="wp_wr_id" id="wp_wr_id" class="inputbox mandatory">
				...
				<tr>
					...
					<td>
						<?php
						$attributes = 'id="ddl_dibuat" class="inputbox"';
						echo form_dropdown('ddl_dibuat', $pejabat_daerah, '', $attributes);
						?>
					</td>
				</tr>
				<tr>
...
<script type="text/javascript">
	var GLOBAL_KARTU_DATA_RESTORAN_VARS = new Array();
	GLOBAL_KARTU_DATA_RESTORAN_VARS["cetak"] = "<?= base_url(); ?>pendataan/kartu_data/pdf_pajak_restoran";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/kartu_data_restoran.js"></script>