...
<script type="text/javascript">
	...
	GLOBAL_PAJAK_AIR_VARS["edit_sptpd"] = "<?= base_url(); ?>pendataan/pajak_air_bawah_tanah/edit";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/view_pajak_air_bawah_tanah.js"></script>