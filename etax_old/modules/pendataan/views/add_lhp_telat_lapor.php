<div id="toolbar-box">
	...
	<div class="m">
		...
		<div class="header icon-48-lhp">
			Isian Laporan Hasil Pemeriksaan (LHP) Telat Lapor: <small><small id='title_head'>[ Baru ]</small></small>
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
			...
			<table class="admintable" border=0 cellspacing="1" width=100%>
				...
				<tr>
					<td align="center">
						...
						&nbsp;&nbsp;&nbsp; TOTAL &nbsp;&nbsp;&nbsp;
						<input type="text" name="total_pajak" id="total_pajak" class="inputbox" size="20" readonly="true" style="font-weight:bold;font-size:25px;color:#18F518;background-color:black;text-align:right;" />
					</td>
				</tr>
			</table>
		</div>
...
<script type="text/javascript">
	...
	GLOBAL_LHP_VARS["insert"] = "<?= base_url(); ?>pendataan/lhp_telat_lapor/save";
	GLOBAL_LHP_VARS["view"] = "<?= base_url(); ?>pendataan/lhp_telat_lapor/view";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/add_lhp_telat_lapor.js"></script>