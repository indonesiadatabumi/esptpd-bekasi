					...
					<td valign="top" class="outsets">
						<table class="admintable">
							...
							<tr>
								...
								<td>
									<input type="text" name="spt_tgl_proses" id="spt_tgl_proses" class="inputbox mandatory" size="11" />
								</td>
							</tr>
							<tr>
								<td class="key">
								...
								<td>
									<input type="text" name="spt_tgl_entry" id="spt_tgl_entry" class="inputbox mandatory" size="11" />
								</td>
							</tr>
							<tr>
								<td class="key">
										...
										<td class="outsets" valign="top">
											<table>
												...
												<tr>
													...
													<td>
														<input type="radio" name="area1" id="area1_1" onchange="execute_area_function(1)" value="1" />&nbsp;Outdoor&nbsp;&nbsp;
														<!--checked="checked"-->
														<input type="radio" name="area1" id="area1_2" onchange="execute_area_function(1)" value="2" />&nbsp;Indoor
														<!--
															<input type="radio" name="area1" id="area1_2" onchange="execute_area_function(1)" value="3" />&nbsp;Tembakau dan Minuman Keras
															-->
													</td>
												</tr>
												...
												<tr>
													...
													<td>
														<input type="checkbox" name="tmk1" id="tmk_1" onchange="execute_tmk_function(1)" value="1" />&nbsp;Rokok&nbsp;&nbsp;
														<input type="checkbox" name="tmk1" id="tmk_2" onchange="execute_tmk_function(1)" value="2" />&nbsp;Minuman Keras
														<!--
															<input type="radio" name="area1" id="area1_2" onchange="execute_area_function(1)" value="3" />&nbsp;Tembakau dan Minuman Keras
															-->
													</td>
												...
												<tr>
													...
													<td>
														<input type="checkbox" name="tinggi1" id="tinggi_1" onchange="execute_tinggi_function(1)" value="1" />&nbsp;Tinggi&nbsp;&nbsp;
												...
												<tr>
													...
													<td>
														<?php
														$attributes = 'id="txt_kode_camat" class="inputbox"';
				...
				<tfoot>
					<tr>
						<td align="center">
							...
							&nbsp;&nbsp;&nbsp;<b>TOTAL PAJAK</b> &nbsp;&nbsp;&nbsp;
							<input type="text" name="spt_pajak" id="spt_pajak" class="inputbox" size="20" value="" onfocus="this.value=unformatCurrency(this.value);" onblur="this.value=formatCurrency(this.value);" readonly="true" style="font-weight:bold;font-size:25px;color:#18F518;background-color:black;text-align:right;" />
						</td>
					</tr>
				</tfoot>
			</table>
...
<script type="text/javascript">
	...
	GLOBAL_PAJAK_REKLAME_VARS["view_import"] = "<?= base_url(); ?>pendataan/pajak_reklame/view_import";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/add_pajak_reklame.js"></script>