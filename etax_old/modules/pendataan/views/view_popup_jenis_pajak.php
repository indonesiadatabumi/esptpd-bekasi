...
<script type="text/javascript">
	function showFormJenisPajak(idRefJenisPajak) {
		...
		if (idRefJenisPajak == "1")
			load_content("<?= base_url(); ?>pendataan/pajak_hotel/add");
		else if (idRefJenisPajak == "2")
			load_content("<?= base_url(); ?>pendataan/pajak_restoran/add");
		else if (idRefJenisPajak == "3")
			load_content("<?= base_url(); ?>pendataan/pajak_hiburan/add");
		else if (idRefJenisPajak == "4")
			load_content("<?= base_url(); ?>pendataan/pajak_reklame/add");
		else if (idRefJenisPajak == "5")
			load_content("<?= base_url(); ?>pendataan/pajak_genset/add");
		else if (idRefJenisPajak == "6")
			load_content("<?= base_url(); ?>pendataan/pajak_pln/add");
		else if (idRefJenisPajak == "7")
			load_content("<?= base_url(); ?>pendataan/pajak_parkir/add");
		else if (idRefJenisPajak == "8")
			load_content("<?= base_url(); ?>pendataan/pajak_air_bawah_tanah/add");
		else if (idRefJenisPajak == "9")
			load_content("<?= base_url(); ?>pendataan/pajak_sarang_walet/add");
	};
