<div id="toolbar-box">
	...
	<div class="m">
		<div class="header icon-48-print">
			Cetak Kartu Data Pajak Hiburan
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
...
<div id="element-box">
	...
	<div class="m">
		<form name="frm_kartu_data_restoran" id="frm_kartu_data_restoran">
			<input type="hidden" name="kodus_id" value="<?= $this->config->item('kodus_hiburan'); ?>">
...
<script type="text/javascript">
	var GLOBAL_KARTU_DATA_HIBURAN_VARS = new Array();
	GLOBAL_KARTU_DATA_HIBURAN_VARS["cetak"] = "<?= base_url(); ?>pendataan/kartu_data/pdf_pajak_hiburan";
</script>

<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/kartu_data_hiburan.js"></script>