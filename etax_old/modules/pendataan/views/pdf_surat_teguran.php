...
if (!empty($ar_wp)) {
	...
	foreach ($ar_wp as $k => $v) {
		...
		$dt[0]['TEXT'] = "";
		$dt[1]['TEXT'] = "S U R A T   T E G U R A N";
		$dt[1]['COLSPAN'] = 2;
		$dt[1]['T_ALIGN'] = "C";
		$dt[1]['T_SIZE'] = 12;
		$dt[1]['T_TYPE'] = "UB";
		...
		$dt[0]['TEXT'] = "";
		$dt[1]['TEXT'] = "NOMOR : " . strtoupper($nomor_surat);
		$dt[1]['COLSPAN'] = 2;
		$dt[1]['T_ALIGN'] = "C";
		$dt[1]['T_SIZE'] = 8;
		$dt[1]['T_TYPE'] = "B";
		...
		$tbd[0]['TEXT'] = "";
		$tbd[1]['TEXT'] = "Menurut pembukuan kami, hingga saat ini Saudara masih mempunyai tunggakan Pajak Daerah sebagai berikut : ";
		$tbd[1]['COLSPAN'] = 2;
		$tbd[1]['T_ALIGN'] = "L";
		$tbd[3]['TEXT'] = "";
		$pdf->tbDrawData($tbd);
		...
		$dt[0]['TEXT'] = "";
		$dt[1]['TEXT'] = "PAJAK HARUS DILUNASI DALAM WAKTU 7\n(TUJUH) HARI SETELAH TANGGAL SURAT";
		$dt[2]['TEXT'] = "";
		$dt[3]['TEXT'] = $pejabat->ref_japeda_nama;
		$dt[1]['T_ALIGN'] = "L";
		$dt[1]['BRD_TYPE'] = 'L';
		$dt[2]['BRD_TYPE'] = 'L';
		$dt[0]['LN_SIZE'] = 4;
		...
		$dt[0]['TEXT'] = "";
		$dt[1]['TEXT'] = "(Undang-Undang No. 28 Tahun 2009)";
		$dt[2]['TEXT'] = "";
		$dt[3]['TEXT'] = $pejabat->pejda_nama;
		$dt[1]['T_ALIGN'] = "L";
		$dt[3]['T_TYPE'] = 'U';
		$dt[1]['BRD_TYPE'] = 'L';
		$dt[2]['BRD_TYPE'] = 'L';
		...
		$dt[0]['TEXT'] = "";
		$dt[1]['TEXT'] = "*) Coret yang tidak perlu";
		$dt[2]['TEXT'] = "";
		$dt[3]['TEXT'] = "";
		$dt[1]['T_ALIGN'] = "L";
		$dt[3]['T_TYPE'] = '';
