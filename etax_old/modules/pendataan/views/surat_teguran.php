...
<script type="text/javascript">
	...
	GLOBAL_SURAT_TEGURAN_VARS["cetak"] = "<?= base_url(); ?>pendataan/surat_teguran/pdf_surat_teguran";
	GLOBAL_SURAT_TEGURAN_VARS["daftar"] = "<?= base_url(); ?>pendataan/surat_teguran/pdf_daftar_surat_teguran";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/surat_teguran.js"></script>