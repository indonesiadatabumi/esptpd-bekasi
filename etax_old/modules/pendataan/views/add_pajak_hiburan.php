<div id="toolbar-box">
	...
	<div class="m">
		...
		<div class="header icon-48-hiburan">
			Isian SPTPD Pajak Hiburan: <small><small id='title_head'>[ Baru ]</small></small>
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
...
<div id="element-box">
	...
	<div class="m">
		...
		$attributes = array('id' => 'frm_add_sptpd_hiburan');
		$hidden = array(
			'mode' => 'add',
		...
		echo form_open('frm_add_sptpd_hiburan', $attributes, $hidden);
		?>
...
<script type="text/javascript">
	...
	GLOBAL_PAJAK_HIBURAN_VARS["insert_sptpd"] = "<?= base_url(); ?>pendataan/pajak_hiburan/save";
	GLOBAL_PAJAK_HIBURAN_VARS["view_sptpd"] = "<?= base_url(); ?>pendataan/pajak_hiburan/view";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/add_pajak_hiburan.js"></script>