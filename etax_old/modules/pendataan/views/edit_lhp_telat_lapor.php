...
<div id="toolbar-box">
    ...
    <div class="m">
        ...
        <div class="header icon-48-lhp">
            Isian Laporan Hasil Pemeriksaan (LHP) Telat Lapor: <small><small id='title_head'>[ Edit ]</small></small>
        </div>
        <div class="clr"></div>
    </div>
    <div class="b">
            ...
            <table class="admintable" border=0 cellspacing="1" width=100%>
                                ...
                                ?>
                                        <tr class="row0" id="row_detail<?= $counter ?>">
                                            ...
                                            <td align="right" valign="top">
                                                ...
                                                Lain-lain :
                                                <input type="text" name="lhp_dt_kredit_pjk_lain[]" id="lhp_dt_kredit_pjk_lain<?= $counter ?>" class="numerics" size="17" onkeyout="calcKreditPajak(<?= $counter ?>);" onchange="calcKreditPajak(<?= $counter ?>);" onblur="this.value=formatCurrency(this.value);" onfocus="this.value=unformatCurrency(this.value);" style="text-align:right;" value="<?= number_format($detail->lhp_dt_kredit_pjk_lain, 2, ',', '.') ?>" /><br>
                                                <hr>
                                                Total :
                                                <?php
                                            ...
                                            <td align="right" valign="top">
                                                ...
                                                Kenaikan :
                                                <input type="text" name="lhp_dt_kenaikan[]" id="lhp_dt_kenaikan<?= $counter ?>" class="numerics" size="17" value="<?= number_format($detail->lhp_dt_kenaikan, 2, ',', '.') ?>" style="text-align:right;" onkeyout="calcSanksi(<?= $counter; ?>);" onchange="calcSanksi(<?= $counter; ?>);" onblur="this.value=formatCurrency(this.value);" onfocus="this.value=unformatCurrency(this.value);" /><br>
                                                <hr>
                                                Total :
                                                <?php
                ...
                <tr>
                    <td align="center">
                        ...
                        &nbsp;&nbsp;&nbsp; TOTAL &nbsp;&nbsp;&nbsp;
                        <input type="text" name="total_pajak" id="total_pajak" value="<?= format_currency($row->lhp_pajak); ?>" class="inputbox" size="20" readonly="true" style="font-weight:bold;font-size:25px;color:#18F518;background-color:black;text-align:right;" />
                    </td>
                </tr>
            </table>
        </div>
...
<script type="text/javascript">
    ...
    GLOBAL_LHP_VARS["update"] = "<?= base_url(); ?>pendataan/lhp_telat_lapor/update";
    GLOBAL_LHP_VARS["view"] = "<?= base_url(); ?>pendataan/lhp_telat_lapor/view";
    GLOBAL_LHP_VARS["insert"] = "<?= base_url(); ?>pendataan/lhp_telat_lapor";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/edit_hasil_pemeriksaan.js"></script>