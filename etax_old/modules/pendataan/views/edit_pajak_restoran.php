<div id="toolbar-box">
	...
	<div class="m">
		...
		<div class="header icon-48-restoran">
			Isian SPTPD Pajak Restoran: <small><small id='title_head'>[ Edit ]</small></small>
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
...
<div id="element-box">
	...
	<div class="m">
		...
		$attributes = array('id' => 'frm_edit_sptpd_restoran');
		$hidden = array(
			'mode' => 'edit',
		...
		echo form_open('frm_edit_sptpd_restoran', $attributes, $hidden);
		?>
					...
					<td valign="top">
						<table class="admintable" border=0 cellspacing="1">
							...
							<?php if ($this->session->userdata('USER_SPT_CODE') == "10") {  ?>
								<tr>
									...
									<td>
										...
										echo form_dropdown('jenis_pajak_restoran', $jenis_pajak_restoran, $dt_pajak_restoran, $attributes);
										?>
									</td>
								</tr>
							<?php } ?>
							...
							<tr>
								...
								<td>
									<input type="text" name="spt_nilai" id="spt_nilai" value="<?= format_currency($row->spt_dt_jumlah); ?>" class="inputbox" size="25" <?= $js; ?> onfocus="this.value=unformatCurrency(this.value);" onkeyup="getPajak('spt_pajak','spt_nilai','korek_persen_tarif');" onblur="getPajak('spt_pajak','spt_nilai','korek_persen_tarif');this.value=formatCurrency(this.value);" style="text-align:right;" />
...
<script type="text/javascript">
	...
	GLOBAL_PAJAK_RESTORAN_VARS["update_sptpd"] = "<?= base_url(); ?>pendataan/pajak_restoran/update";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/edit_pajak_restoran.js"></script>