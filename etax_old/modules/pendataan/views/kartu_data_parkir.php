...
<div id="element-box">
	...
	<div class="m">
		<form name="frm_kartu_data_restoran" id="frm_kartu_data_restoran">
			<input type="hidden" name="kodus_id" value="<?= $this->config->item('kodus_parkir'); ?>">
...
<script type="text/javascript">
	var GLOBAL_KARTU_DATA_PARKIR_VARS = new Array();
	GLOBAL_KARTU_DATA_PARKIR_VARS["cetak"] = "<?= base_url(); ?>pendataan/kartu_data/pdf_pajak_parkir";
</script>

<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/kartu_data_parkir.js"></script>