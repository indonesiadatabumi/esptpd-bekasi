			...
			<table class="admintable">
				...
				<tr>
					...
					<td>
						...
						<input type="text" name="tgl_pendataan_awal" id="tgl_pendataan_awal" size="11" />
						<label class="key">s/d</label>
						<input type="text" name="tgl_pendataan_akhir" id="tgl_pendataan_akhir" size="11" />
					</td>
				</tr>
				<tr>
					<td width="150" class="key">
...
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/daftar_kartu_data.js"></script>