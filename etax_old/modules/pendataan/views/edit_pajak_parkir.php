<div id="toolbar-box">
	...
	<div class="m">
		...
		<div class="header icon-48-parkir">
			Isian SPTPD Pajak Parkir: <small><small id='title_head'>[ Edit ]</small></small>
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
...
<div id="element-box">
	...
	<div class="m">
		...
		$attributes = array('id' => 'frm_edit_sptpd_parkir');
		$hidden = array(
			'mode' => 'edit',
		...
		echo form_open('frm_edit_sptpd_parkir', $attributes, $hidden);
		?>
...
<script type="text/javascript">
	...
	GLOBAL_PAJAK_PARKIR_VARS["update_sptpd"] = "<?= base_url(); ?>pendataan/pajak_parkir/update";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/edit_pajak_parkir.js"></script>