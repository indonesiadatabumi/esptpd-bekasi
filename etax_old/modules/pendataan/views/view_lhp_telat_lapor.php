<div id="toolbar-box">
	...
	<div class="m">
		...
		<div class="header icon-48-lhp">
			Daftar Laporan Hasil Pemeriksaan (LHP) Telat Lapor
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
...
<script type="text/javascript">
	...
	GLOBAL_LHP_VARS["get_list"] = "<?= base_url(); ?>pendataan/lhp_telat_lapor/get_list";
	GLOBAL_LHP_VARS["add"] = "<?= base_url(); ?>pendataan/lhp_telat_lapor";
	GLOBAL_LHP_VARS["edit"] = "<?= base_url(); ?>pendataan/lhp_telat_lapor/edit";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendataan/scripts/view_lhp_telat_lapor.js"></script>