var insertOptionRekening = function(idSelect) {
	$.get(GLOBAL_PAJAK_AIR_VARS["get_rekening"], { koderek : $("input[name=korek]").val() }, function(data){
		var option = "";
...
var appendRowField = function(id) {
	var rowField = 
		'<tr class="row0" id="row_detail'+ id +'" >'+
			...
			'</td>'+
			'<td align="right">'+
				'<input type="text" name="spt_dt_jumlah[]" id="spt_dt_jumlah'+ id +'" class="inputbox" size="8" value="" onchange="getPajak(\'spt_dt_pajak'+ id +'\',\'spt_dt_persen_tarif'+ id +'\',\'spt_dt_dasar_pengenaan'+ id +'\',\'spt_dt_dasar_pengenaan'+ id +'\',\'spt_dt_jumlah'+ id +'\');calc1();" style="text-align:right;" autocomplete="off"/>'+
			'</td>'+
			'<td>'+
				'<input type="text" name="spt_dt_dasar_pengenaan[]" id="spt_dt_dasar_pengenaan'+ id +'" class="inputbox" size="16" value="" onchange="getPajak(\'spt_dt_pajak'+ id +'\',\'spt_dt_persen_tarif'+ id +'\',\'spt_dt_dasar_pengenaan'+ id +'\',\'spt_dt_dasar_pengenaan'+ id +'\',\'spt_dt_jumlah'+ id +'\');calc1();" style="text-align:right;" autocomplete="off"/>'+
			'</td>'+
			'<td align="right">'+
			...
			'</td>'+
			'<td align="right">'+
				'<input type="text" name="spt_dt_pajak[]" id="spt_dt_pajak'+ id +'" class="inputbox" size="14" value="" readonly="true" style="text-align:right;"/></td>'+
...
var updateData = function() {
	...
	var save_options = { 
		url : GLOBAL_PAJAK_AIR_VARS["update_sptpd"],
		type : "POST",
		dataType: 'json',
	...
	$("#frm_edit_sptpd_air").ajaxSubmit(save_options);
};
