    ...
    <div class="tab-pane tabs-animation fade active show" id="tab-content-0" role="tabpanel">
        <div class="row">
                            ...
                            <div class="no-gutters row">
                                <div class="col-sm-6 col-xl-4">
                                    <button class="btn-icon-vertical btn-square btn-transition btn btn-outline-primary" onclick="window.location.href='navigation/pendaftaran';">
                                        <i class="btn-icon-wrapper pe-7s-news-paper"> </i>Pelayanan
                                    </button>
                                </div>
                                <div class="col-sm-6 col-xl-4">
            ...
            <div class="col-lg-12 col-xl-6">
                <div class="main-card mb-3 card border">
                    <div class="card-body">
                        <h5 class="card-title">PBB & BPHTB</h5>
                        <div class="grid-menu grid-menu-2col">
                            <div class="no-gutters row">
                                <div class="col-sm-6">
                                    <button class="btn-icon-vertical btn-square btn-transition btn btn-outline-primary" onclick="window.open('http://112.78.188.246/esismiop/'),'_blank';">
                                        <i class="btn-icon-wrapper pe-7s-map-marker "> </i> e-PBB
                                    </button>
                                </div>
                                <div class="col-sm-6">
                                    <button class="btn-icon-vertical btn-square btn-transition btn btn-outline-secondary" onclick="window.open('http://ebphtb.bekasikota.go.id'),'_blank';">
                                        <i class="pe-7s-map btn-icon-wrapper"> </i>e-BPHTB
                                    </button>
                                </div> 
                                <div class="col-sm-6">
                                    <button class="btn-icon-vertical btn-square btn-transition btn btn-outline-link" onclick="window.open('http://112.78.188.246/esppt/'),'_blank';">
            ...
            <?php if ($this->session->userdata('USER_JABATAN') == '200' || $this->session->userdata('USER_JABATAN') == '98') : ?>
                ...
                <div class="col-lg-12 col-xl-6">
                    <div class="main-card mb-3 card border">
                        <div class="card-body">
                            <h5 class="card-title">PBJT & RETRIBUSI</h5>
                            <div class="grid-menu grid-menu-3col">
                                <div class="no-gutters row">
                                    <div class="col-sm-6 col-xl-4">
                                        <button class="btn-icon-vertical btn-square btn-transition btn btn-outline-link" onclick="window.open('http://sipdah.bekasikota.go.id/'),'_blank';">
                                            <i class="pe-7s-browser btn-icon-wrapper btn-icon-lg mb-3"></i>e-SPTPD
                                        </button>
                                    </div>
                                    <div class="col-sm-6 col-xl-4">
                                        <button class="btn-icon-vertical btn-square btn-transition btn btn-outline-success" onclick="window.open('http://sipdah.bekasikota.go.id/siprd/'), '_blank';">
                                            <i class="pe-7s-car btn-icon-wrapper"> </i>e-Retribusi
                                        </button>
                                    </div>
                                    <div class="col-sm-6 col-xl-4">
                                        <button class="btn-icon-vertical btn-square btn-transition btn btn-outline-link" onclick="window.open('https://mpokesi.bekasikota.go.id/login'),'_blank';">
                                    ...
                                    <!-- <div class="col-sm-6 col-xl-4">
                                        <button class="btn-icon-vertical btn-square btn-transition btn btn-outline-link" onclick="window.open('http://117.102.88.50/web-service'),'_blank';">
                    ...
                    <div class="main-card mb-3 card border">
                        <div class="card-body">
                            ...
                            <div class="grid-menu grid-menu-2col">
                                <div class="no-gutters row">
                                    <div class="col-sm-6">
                                        <button class="btn-icon-vertical btn-square btn-transition btn btn-outline-link" onclick="window.location.href='navigation/setting';">
                                            <i class="pe-7s-tools btn-icon-wrapper btn-icon-lg mb-3"></i>Setting
                                        </button>
                                    </div>
                                    <div class="col-sm-6">
                                        <button class="btn-icon-vertical btn-square btn-transition btn btn-outline-link">
                                            <i class="pe-7s-server btn-icon-wrapper btn-icon-lg mb-3"></i>Bapenda-API
                                        </button>
                                    </div>
                                    <div class="col-sm-6">
                                        <button class="btn-icon-vertical btn-square btn-transition btn btn-outline-link">
