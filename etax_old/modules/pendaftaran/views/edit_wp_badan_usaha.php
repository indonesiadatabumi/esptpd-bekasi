<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Edit Wajib Pajak</li>
  </ol>
</nav>
...
<div class="row mt-3">
	<div class="col">
		<div class="card border">
			<div class="card-body">
				<form method="post" name="frm_edit_wp_bu" id="frm_edit_wp_bu">
					...
					<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link" id="pills-bidang_usaha-tab" data-toggle="pill" href="#pills-bidang_usaha" role="tab" aria-controls="pills-bidang_usaha" aria-selected="false">BIDANG USAHA</a>
						</li>
					</ul>
					<div class="tab-content" id="pills-tabContent">
						<div class="tab-pane fade show active" id="pills-identitas" role="tabpanel" aria-labelledby="pills-identitas-tab">
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control mandatory" id="wp_wr_no_urut" name="wp_wr_no_urut" maxlength="7" readonly value="<?= $row->wp_wr_no_urut; ?>" >
								</div>
								<div class="col-sm-2">
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control mandatory" id="wp_wr_nama" name="wp_wr_nama" style="text-transform: uppercase;" value="<?= $row->wp_wr_nama; ?>">
								</div>
							</div>
							<div class="form-group row">
								<label for="wp_wr_almt" class="col-sm-2 col-form-label">Alamat</label>
								<div class="col-sm-8">
									<textarea class="form-control mandatory" id="wp_wr_almt" name="wp_wr_almt" style="text-transform: uppercase;" rows="3"><?= $row->wp_wr_almt; ?></textarea>
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<?php
									$attributes = 'id="wp_wr_kd_lurah" class="form-control"';
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control mandatory" id="wp_wr_kabupaten" name="wp_wr_kabupaten" value="<?= $row->wp_wr_kabupaten; ?>" style="text-transform: uppercase;" readonly>
								</div>
							</div>
							<div class="form-group row">
								<label for="wp_wr_telp" class="col-sm-2 col-form-label">No. Telp</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="wp_wr_telp" name="wp_wr_telp" style="text-transform: uppercase;" value="<?= $row->wp_wr_telp; ?>">
								</div>
							</div>
							<div class="form-group row">
								<label for="wp_wr_kodepos" class="col-sm-2 col-form-label">Kodepos</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="wp_wr_kodepos" name="wp_wr_kodepos" maxlength="5" style="text-transform: uppercase;" value="<?= $row->wp_wr_kodepos; ?>">
								</div>
							</div>
							<hr>
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control mandatory" id="wp_wr_nama_milik" name="wp_wr_nama_milik" style="text-transform: uppercase;" value="<?= $row->wp_wr_nama_milik; ?>">
								</div>
							</div>
							<div class="form-group row">
								<label for="wp_wr_almt_milik" class="col-sm-2 col-form-label">Alamat</label>
								<div class="col-sm-8">
									<textarea class="form-control mandatory" id="wp_wr_almt_milik" name="wp_wr_almt_milik" style="text-transform: uppercase;" rows="3"><?= $row->wp_wr_almt_milik; ?></textarea>
								</div>
							</div>
							<div class="form-group row">
								<label for="wp_wr_lurah_milik" class="col-sm-2 col-form-label">Kelurahan</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="wp_wr_lurah_milik" name="wp_wr_lurah_milik" style="text-transform: uppercase;" value="<?= $row->wp_wr_lurah_milik; ?>">
								</div>
							</div>
							<div class="form-group row">
								<label for="wp_wr_camat_milik" class="col-sm-2 col-form-label">Kecamatan</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="wp_wr_camat_milik" name="wp_wr_camat_milik" style="text-transform: uppercase;" value="<?= $row->wp_wr_camat_milik; ?>">
								</div>
							</div>
							<div class="form-group row">
								<label for="wp_wr_kabupaten_milik" class="col-sm-2 col-form-label">Kabupaten/Kota</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="wp_wr_kabupaten_milik" name="wp_wr_kabupaten_milik" value="<?= $row->wp_wr_kabupaten_milik; ?>" style="text-transform: uppercase;">
								</div>
							</div>
							<div class="form-group row">
								<label for="wp_wr_telp_milik" class="col-sm-2 col-form-label">No. Telp</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="wp_wr_telp_milik" name="wp_wr_telp_milik" style="text-transform: uppercase;" value="<?= $row->wp_wr_telp_milik; ?>">
								</div>
							</div>
							<div class="form-group row">
								<label for="wp_wr_kodepos_milik" class="col-sm-2 col-form-label">Kodepos</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="wp_wr_kodepos_milik" name="wp_wr_kodepos_milik" maxlength="5" style="text-transform: uppercase;" value="<?= $row->wp_wr_kodepos_milik; ?>">
								</div>
							</div>
							<div class="form-group row">
								<label for="wp_wr_nik" class="col-sm-2 col-form-label">No. NIB/NIK</label>
								<div class="col-sm-8">
									<input type="text" class="form-control mandatory" id="wp_wr_nik" name="wp_wr_nik" style="text-transform: uppercase;" value="<?= $row->wp_wr_nik; ?>">
								</div>
							</div>
							<div class="form-group row">
								<label for="f_date_a" class="col-sm-2 col-form-label">Tgl Diterima WP</label>
								<div class="col-sm-8">
									<input type="text" class="form-control mandatory" id="f_date_a" name="wp_wr_tgl_terima_form" value="<?= date_format(date_create($row->wp_wr_tgl_terima_form), 'd-m-Y'); ?>">
								</div>
							</div>
							<div class="form-group row">
								<label for="f_date_b" class="col-sm-2 col-form-label">Tgl Batas Kirim</label>
								<div class="col-sm-8">
									<input type="text" class="form-control mandatory" id="f_date_b" name="wp_wr_tgl_bts_kirim" value="<?= date_format(date_create($row->wp_wr_tgl_bts_kirim), 'd-m-Y'); ?>">
								</div>
							</div>
							<div class="form-group row">
								<label for="f_date_c" class="col-sm-2 col-form-label">Tgl Pendaftaran</label>
								<div class="col-sm-8">
									<input type="text" class="form-control mandatory" id="f_date_c" name="wp_wr_tgl_kartu" value="<?= date_format(date_create($row->wp_wr_tgl_kartu), 'd-m-Y'); ?>">
								</div>
							</div>
							<button type="button" id="btn_update" class="btn btn-block btn-primary"><i class="fas fa-save"> Update </i></button>
						</div>
						<div class="tab-pane fade" id="pills-bidang_usaha" role="tabpanel" aria-labelledby="pills-bidang_usaha-tab">
							<div class="row">
								<div class="col">
									<?php
...
<script type="text/javascript">
	...
	GLOBAL_WP_BU_VARS["view_wp_bu"] = "<?= base_url(); ?>pendaftaran/wp_badan_usaha/view";
	GLOBAL_WP_BU_VARS["add_wp_bu"] = "<?= base_url(); ?>pendaftaran/wp_badan_usaha/add";
	GLOBAL_WP_BU_VARS["update_wp_bu"] = "<?= base_url(); ?>pendaftaran/wp_badan_usaha/update";
	GLOBAL_WP_BU_VARS["get_wp_detail"] = "<?= base_url(); ?>pendaftaran/wp_badan_usaha/get_wp_detail";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendaftaran/scripts/edit_wp_badan_usaha.js"></script>