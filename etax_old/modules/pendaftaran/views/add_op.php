		...
		<div class="card border">
			<div class="card-body">
				<form method="post" name="frm_add_wp_bu" id="frm_add_wp_bu">
					...
					<input type="hidden" name="wp_wr_nama_milik" value="<?= $row->wp_wr_nama_milik ?>"/>
					<input type="hidden" name="wp_wr_almt_milik" value="<?= $row->wp_wr_almt_milik ?>"/>
					<input type="hidden" name="wp_wr_lurah_milik" value="<?= $row->wp_wr_lurah_milik ?>"/>
					<input type="hidden" name="wp_wr_camat_milik" value="<?= $row->wp_wr_camat_milik ?>"/>
					<input type="hidden" name="wp_wr_kabupaten_milik" value="<?= $row->wp_wr_kabupaten_milik ?>"/>
					<input type="hidden" name="wp_wr_telp_milik" value="<?= $row->wp_wr_telp_milik ?>"/>
					<input type="hidden" name="wp_wr_kodepos_milik" value="<?= $row->wp_wr_kodepos_milik ?>"/>
					<input type="hidden" name="wp_wr_nik" value="<?= $row->wp_wr_nik ?>"/>
...
<script type="text/javascript">
	...
	GLOBAL_WP_BU_VARS["save_wp_badan_usaha"] = "<?= base_url(); ?>pendaftaran/wp_badan_usaha/save_op/";
