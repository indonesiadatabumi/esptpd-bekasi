<div id="toolbar-box">
	...
	<div class="m">
		...
		<div class="header icon-48-pendaftaran_p">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="text" name="wp_wr_npwpd" id="wp_wr_npwpd" class="inputbox" size="20" value="<?= $row->npwprd; ?>" readonly="true" style="font-weight:bold;font-size:25px;color:#18F518;background-color:black;text-align:center;" />
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
								...
								<td valign="top">
									<table class="admintable" border=0 cellspacing="1">
										...
										<tr>
											...
											<td>
												<input type="text" name="wp_wr_tgl_terima_form" id="f_date_a" size="10" value="<?= date_format(date_create($row->wp_wr_tgl_terima_form), 'd-m-Y'); ?>" class="mandatory" />
											</td>
										</tr>
							</tr>
							<tr>
...
<script type="text/javascript" src="<?= base_url(); ?>modules/pendaftaran/scripts/edit_wp_pribadi.js"></script>