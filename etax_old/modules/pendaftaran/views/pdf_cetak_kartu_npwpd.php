...
$kop[0]['TEXT'] = "";
$kop[1]['TEXT'] = "BADAN PENDAPATAN DAERAH";
...
$ttd[0]['TEXT'] = "";
$ttd[1]['TEXT'] = "<an>a.n Walikota Bekasi\nKepala Badan Pendapatan Daerah</an>";
$ttd[1]['LN_SIZE'] = 2.4;
$pdf->tbDrawData($ttd);
...
$logo = "assets/images/ttd_kaban_baru.jpg";
$pdf->Image($logo,53,50,24,7);

$logo = "assets/images/stempell.jpg";
$pdf->Image($logo,40,50,13,13);
