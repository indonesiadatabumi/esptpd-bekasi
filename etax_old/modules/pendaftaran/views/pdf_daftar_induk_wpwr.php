...
$th1[0]['TEXT'] = "<b>NO.</b>";
$th1[1]['TEXT'] = "<b>TANGGAL DAFTAR</b>";
$th1[2]['TEXT'] = "<b>N P W P D</b>";
$th1[3]['TEXT'] = "<b>N A M A</b>";
$th1[4]['TEXT'] = "<b>A L A M A T   L E N G K A P</b>";
$th1[5]['TEXT'] = "<b>KETERANGAN</b>";
$th1[1]['LN_SIZE'] = 8;
$th1[0]['BRD_TYPE'] = 'LT';
$th1[1]['BRD_TYPE'] = 'LT';
$th1[2]['BRD_TYPE'] = 'LT';
			...
			foreach($ar_data as $k => $v) {
				...
				if(!empty($ardat)) {
					...
					foreach($ardat as $k1 => $v1) {
						...
						$data2[0]['TEXT'] = $nmr . ".";
						$data2[1]['TEXT'] = $v1['wp_wr_tgl_kartu'];
						$data2[2]['TEXT'] = $v1['npwprd'];
						$data2[3]['TEXT'] = $v1['wp_wr_nama'];
						$data2[4]['TEXT'] = strtoupper($alamat_lengkap);
						//$data2[4]['TEXT'] = $v1[wp_wr_nama_milik];
						$data2[5]['TEXT'] = "";
						
						$data2[0]['T_ALIGN'] = 'R';$data2[2]['T_ALIGN'] = 'C';$data2[5]['T_ALIGN'] = 'C';
						$data2[0]['BRD_TYPE'] = 'LT';$data2[1]['BRD_TYPE'] = 'LT';$data2[2]['BRD_TYPE'] = 'LT';$data2[3]['BRD_TYPE'] = 'LT';;$data2[4]['BRD_TYPE'] = 'LT';$data2[5]['BRD_TYPE'] = 'LRT';
						$data2[0]['T_SIZE'] = 8;$data2[1]['T_SIZE'] = 8;$data2[2]['T_SIZE'] = 8;$data2[3]['T_SIZE'] = 8;$data2[4]['T_SIZE'] = 8;
						$data2[0]['LN_SIZE'] = $linespace;$data2[1]['LN_SIZE'] = $linespace;$data2[2]['LN_SIZE'] = $linespace;$data2[3]['LN_SIZE'] = $linespace;$data2[4]['LN_SIZE'] = $linespace;$data2[5]['LN_SIZE'] = $linespace;
			...
			foreach($ar_data as $k => $v) {
				...
				if(!empty($ardat)) {
					...
					foreach($ardat as $k1 => $v1) {
						...
						$data2[0]['T_ALIGN'] = 'R';$data2[2]['T_ALIGN'] = 'C';$data2[5]['T_ALIGN'] = 'C';
						$data2[0]['BRD_TYPE'] = 'LT';$data2[1]['BRD_TYPE'] = 'LT';$data2[2]['BRD_TYPE'] = 'LT';$data2[3]['BRD_TYPE'] = 'LT';$data2[4]['BRD_TYPE'] = 'LT';$data2[5]['BRD_TYPE'] = 'LRT';
						$data2[0]['T_SIZE'] = 8;$data2[1]['T_SIZE'] = 8;$data2[2]['T_SIZE'] = 8;$data2[3]['T_SIZE'] = 8;$data2[4]['T_SIZE'] = 8;$data2[5]['T_SIZE'] = 8;
						$data2[0]['LN_SIZE'] = $linespace;$data2[1]['LN_SIZE'] = $linespace;$data2[2]['LN_SIZE'] = $linespace;$data2[3]['LN_SIZE'] = $linespace;$data2[4]['LN_SIZE'] = $linespace;$data2[5]['LN_SIZE'] = $linespace;
	...
	case 4:
		...
		if(!empty($ar_data)) {
			...
			foreach($ar_data as $k => $v) {
				...
				$data1[1]['TEXT'] = "" . $v['wp_wr_tgl_kartu'];
				$data1[2]['TEXT'] = "" . $v['npwprd'];
				$data1[3]['TEXT'] = "" . $v['wp_wr_nama'];
				$data1[4]['TEXT'] = "" . strtoupper($alamat_lengkap);
				//$data1[4]['TEXT'] = "" . $v[wp_wr_nama_milik];
				if(!empty($wpwr_kdusaha)) $data1[5]['TEXT'] = "";
				else $data1[5]['TEXT'] = strtoupper($kodus);

				$data1[0]['T_ALIGN'] = 'R';$data1[2]['T_ALIGN'] = 'C';$data1[5]['T_ALIGN'] = 'C';
				$data1[0]['BRD_TYPE'] = 'LT';$data1[1]['BRD_TYPE'] = 'LT';$data1[2]['BRD_TYPE'] = 'LT';$data1[3]['BRD_TYPE'] = 'LT';$data1[4]['BRD_TYPE'] = 'LT';$data1[5]['BRD_TYPE'] = 'LRT';
