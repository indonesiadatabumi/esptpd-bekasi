	...
	<div class="col-lg-12">
		<div class="main-card mb-6 card">
			<div class="card-header">
				<h5 class="card-title">Cetak Daftar Induk WP Baru</small> </h5>
				...
				<div id="element-box">
					...
					<div class="m">
						...
						<form name="frm_daftar_induk" id="frm_daftar_induk" action="" method="post">
							<fieldset>
								<legend>Cetak Daftar Induk WP Baru</legend>
...
<script type="text/javascript" src="<?= base_url(); ?>modules/pendaftaran/scripts/form_daftar_induk_wpwr_baru.js"></script>