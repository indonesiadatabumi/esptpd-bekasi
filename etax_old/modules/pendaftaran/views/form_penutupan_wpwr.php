...
<div id="element-box">
	...
	<div class="m">
		<!-- content body -->
		<form method="post" name="frm_penutupan_wp" id="frm_penutupan_wp">
					...
					<td class="outsets" valign="top">
						<table class="admintable">
							<tr>
								...
								<td>
									<input type="text" name="tgl_tutup" id="f_date_tutup" size="10" class="mandatory" tabindex="1" value="" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="key" valign="top">
									<label for="username">Pemilik/Penanggung Jawab</label>
								</td>
								<td>
									<input type="text" name="wp_wr_nama_milik" id="wp_wr_nama_milik" class="inputbox" size="40" readonly="true" style="text-transform: uppercase;">
								</td>
							</tr>
							<tr>
								<td class="key" valign="top">
...
<script type="text/javascript">
	var GLOBAL_TUTUP_WP_WR_VARS = new Array();
	GLOBAL_TUTUP_WP_WR_VARS["add_wpwr_tutup"] = "<?= base_url(); ?>pendaftaran/penutupan_wpwr/add";
</script>
<script type="text/javascript" src="<?= base_url(); ?>modules/pendaftaran/scripts/form_penutupan_wpwr.js"></script>