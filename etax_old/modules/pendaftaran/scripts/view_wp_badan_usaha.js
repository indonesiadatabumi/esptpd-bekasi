...
// 			{display: 'NPWPD', name : 'wp_wr_nik', width : 110, sortable : true, align: 'left', process: cellClick},
// 			{display: 'NOPD', name : 'npwprd', width : 100, sortable : true, align: 'left', process: cellClick},
...
// 			{display: 'NPWPD', name : 'wp_wr_nik'},
// 			{display: 'NOPD', name : 'npwprd'},
 ...
 * @returns
 */
 var addOP = function(wp_wr_nik) {
	load_content(GLOBAL_WP_BU_VARS["tambah_op"], {'wp_wr_nik' : wp_wr_nik});
};
