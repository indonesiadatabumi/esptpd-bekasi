...
// if (menu_id.substr(22, 5) == "popup") {
// 				if (menu_id.substr(22) == "popup_pendataan/objek_pajak/popup_jenis_pajak") {
// 					showDialog(menu_id.substr(28), 'Jenis Pajak', 800, 500);
// 				} else if (menu_id.substr(22) == "popup_pendataan/kartu_data/jenis_pajak") {
// 					showDialog(menu_id.substr(28), 'Kartu Data', 800, 500);
// 				}
// 			} else
// 				load_content(menu_id);