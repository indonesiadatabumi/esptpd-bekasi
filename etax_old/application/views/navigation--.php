                        ...
                        <div class="grid-menu grid-menu-3col">
                            <div class="no-gutters row">
                                <div class="col-sm-6 col-xl-4">
                                    <button class="btn-icon-vertical btn-square btn-transition btn btn-outline-primary" onclick="window.location.href='popup_pendataan/objek_pajak/popup_jenis_pajak';">
                                        <i class="btn-icon-wrapper pe-7s-news-paper"> </i>Pendaftaran
                                    </button>
                                </div>
                                <div class="col-sm-6 col-xl-4">
                                    <button class="btn-icon-vertical btn-square btn-transition btn btn-outline-secondary" onclick="window.location.href='pendaftaran/wp_pribadi';">
                                        <i class="pe-7s-map-2 btn-icon-wrapper"> </i>Pendataan
                                    </button>
                                </div>
                                <div class="col-sm-6 col-xl-4">
                                    <button class="btn-icon-vertical btn-square btn-transition btn btn-outline-success" onclick="window.location.href='pendaftaran/wp_pribadi';">
