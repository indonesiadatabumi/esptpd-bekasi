	...
	<form name="form_login" id="form_login" method="post" onsubmit="return false;">
		...
		<div id="footer">
			...
			<p align="center">
				...
				<!-- &copy;&nbsp;Copyright <a href="http://teknosoftmedia.com" target="_blank">PT. Mitra Prima Utama</a>2010 -->
			</p>

		</div>
		<div style="margin-left:200px; margin-right:10px; ">
			<marquee behavior="slide" width="90%" scrolldelay="100" style="color:#00ff00; font-weight:bold; font-size:22px;" onmouseover="this.stop();" onmouseout="this.start();">
				>> PENYALAHGUNAAN USER MENJADI TANGGUNGJAWAB PEMILIK USER, UNTUK KEAMANAN GANTI PASSWORD SECARA BERKALA. << </marquee>
		</div>
