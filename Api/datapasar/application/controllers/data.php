...
/*
    function index_get() {
      ...
      */
      function index_post() {
        ...
        $this->db->select('npwrd,no_skrd,bln_retribusi,thn_retribusi,kd_billing, wp_wr_nama,wp_wr_alamat,wp_wr_lurah,wp_wr_camat,wp_wr_kabupaten,kd_rekening,nm_rekening,total_retribusi,tgl_penetapan,status_ketetapan');
        //$this->db->select('*');
		$this->db->from('public.v_data_pasar3');
	...
	/*
		  ...
		  $curr_mounth=date('m');
		   ...
		   $this->db->from('app_nota_perhitungan');
        ...
        $no_nota_perhitungan=$daftar['no_nota_perhitungan'];
		
		$bln_retribusi=$daftar['bln_retribusi'];
		$thn_retribusi=$daftar['thn_retribusi'];
		$kd_rekening=$daftar['kd_rekening'];
		$nm_rekening=$daftar['nm_rekening'];
		$dasar_pengenaan=$daftar['dasar_pengenaan'];
		$jenis_ketetapan=$daftar['jenis_ketetapan'];
		$keterangan=$daftar['keterangan'];
		$total_retribusi=$daftar['total_retribusi'];
		$fk_skrd=$daftar['fk_skrd'];
		$id_nota=$daftar['id_nota'];
           }
  ...
  */
  ...
  /*
		...
		$tgl_input=$daftari['tgl_input'];
		$tgl_skrd=$daftari['tgl_skrd'];
		$tgl_penetapan=$daftari['tgl_penetapan'];
		$status_ketetapan=$daftari['status_ketetapan'];
		$status_bayar=$daftari['status_bayar'];
		$status_lunas=$daftari['status_lunas'];
		$id_skrd=$daftari['id_skrd'];
		}
    ...
    'tgl_input'=> $tgl_input,
    'tgl_skrd'=>$tgl_penetapan,
    'tgl_penetapan'=> $tgl_penetapan,
    'status_ketetapan'=> $status_ketetapan,
