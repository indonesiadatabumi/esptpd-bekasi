    ...
    <script type="text/javascript">
      ...
      function cekNPWPD(val) {
        ...
        if (level == '4') {
          ...
          // else {
          //   url = "<?= site_url('user/get_namapegawai') ?>"
          // }
          // if (level == '4') {
          $.ajax({
            type: "POST",
      ...
      function cekNIP(val) {
        ...
        var npwpd = val;
        var url = "<?= site_url('user/get_namapegawai') ?>";
        $.ajax({
          type: "POST",
          url: url,
          dataType: "JSON",
            ...
            <form action="#" id="form" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group row nip">
                  ...
                  <div class="col-sm-9 kosong">
                    <input type="text" class="form-control" name="nip" id="nip" onblur="cekNIP(this.value)" placeholder="NIP">
                    <p id="namapegawai" style="font-style: oblique; font-size:medium; color:red; text-align:right"></p>
                  </div>
                </div>
