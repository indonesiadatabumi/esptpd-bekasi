                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="spt_dt_korek" id="spt_dt_korek" class="form-control-sm" value="<?= $spt_dt_korek ?>" size="30" readonly="true" style="background-color:azure;" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <select name="nama_rekening" id="nama_rekening" style="width:300px; ">
                                        <option value=""> -- Pilih Golongan Hotel --</option>
                                        <?php
                                        foreach ($list_rekening as $l) {
                                            if ($spt_dt_korek == $l->korek_id)
                                                echo " <option value='" . $l->korek_id . "' selected>" . $l->korek_nama . "</option>";
                                            else
                                                echo " <option value='" . $l->korek_id . "'>" . $l->korek_nama . "</option>";
                                        }
                                        ?>
                                    </select>
