...
<script>
    ...
    var appendRowField = function(id) {
        var rowField =
            ...
            '</td>' +
            '<td align="right">' +
            '<input type="text" name="spt_dt_persen_tarif[]" id="spt_dt_persen_tarif' + id + '" class="inputbox" size="2" value=""  readonly="true" style="text-align:right;background-color:azure;"/>' +
            '</td>' +
            '<td align="right">' +
            '<input type="text" name="spt_dt_pajak[]" id="spt_dt_pajak' + id + '" class="inputbox" size="16" value="" readonly="true" style="text-align:right;background-color:azure;"/></td>' +
            '<td><a href="#" class="btn btn-xs btn-outline-danger" onClick="removeFormField(\'#row_detail' + id + '\');calc1();return false;"><i class="fa fa-trash-alt"></i> Hapus</a></td>' +
            '</tr>';
    ...
    var appendRowField_s = function(id) {
        var rowField =
            ...
            '</td>' +
            '<td align="right">' +
            '<input type="text" name="specs_xx[]" id="specs_xx' + id + '" class="inputbox" size="20" value=""  style="text-align:right;background-color:azure;"/>' +
            '</td>' +
            '<td align="right">' +
            '<input type="text" name="specs_xxx[]" id="specs_xxx' + id + '" class="inputbox" size="20" value="" style="text-align:right;background-color:azure;"/></td>' +
            '<td><a href="#" class="btn btn-xs btn-outline-danger" onClick="removeFormField_s(\'#row_detail_s' + id + '\');calc1();return false;"><i class="fa fa-trash-alt"></i> Hapus</a></td>' +
            '</tr>';
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="kd_rekening" id="kd_rekening" class="form-control-sm" value="36" size="30" readonly="true" style="background-color:azure;" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="spt_tgl_entry" id="spt_tgl_entryy" value="<?= date('d/m/Y') ?>" class="mandatory" size="12" readonly="true" style="background-color:azure;" />
                                </td>
                            </tr> -->
                            <tr>
                                <td class="key">
                                                        ...
                                                        <table class="adminlist" cellspacing="1" id="detailTable" border="0" width="100%">
                                                            <thead style="background-color:azure;">
                                                                <tr>
                                                                    ...
                                                                    <th class="title" rowspan="2" width="60" style="width:100px; vertical-align:middle; text-align:center;">-</th>
                                                                </tr>
                                                                <tr>
