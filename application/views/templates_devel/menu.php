...
$query_count_notif = $this->db->select('*');
$query_count_notif = $this->db->from('notification');
$query_count_notif = $this->db->where('type', '1');
$query_count_notif = $this->db->where('status', '0');

$count_notif = $query_count_notif->count_all_results();

$query_notif = $this->db->select('*');
$query_notif = $this->db->where('type', '1');
$query_notif = $this->db->where('status', '0');
$query_notif = $this->db->get('notification');
?>
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        <span class="dropdown-item dropdown-header"><?= $count_notif ?> Pembeitahuan</span>
        <div class="dropdown-divider"></div>
        <?php foreach ($query_notif->result() as $rows) : ?>
          <a href="<?= $rows->url?>" class="dropdown-item">
            <i class="fas fa-user mr-2"></i> <?= $rows->messages?>
    ...
    <li class="nav-item">
      <a href="<?php echo base_url('profil_devel') ?>" class="nav-link">
    ...
    <li class="nav-item">
      <a class="nav-link" href="<?php echo base_url('login_devel/logout') ?>" role="button">
...
<aside class="main-sidebar sidebar-dark-info  elevation-4">
  <!-- Brand Logo -->
  <a href="<?php echo base_url('dashboard_devel'); ?>" class="brand-link navbar-cyan">
  ...
  <div class="sidebar ">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="<?= base_url('dashboard_wp') ?>" class="nav-link">
            <i class="nav-icon fas fas fa-tachometer-alt"></i>
            <p>Dashboard</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?= base_url('esptpd_devel') ?>" class="nav-link">
            <i class="nav-icon fas  far fa-circle text-bold"></i>
            <p>Pelaporan eSPTPD</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?= base_url('cetak_npwpd')?>" class="nav-link">
            <i class="nav-icon fas  far fa-circle text-bold"></i>
            <p>Cetak NPWPD Devel</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?= base_url('konfirmasi_op') ?>" class="nav-link">
            <i class="nav-icon fas  fa-file-alt text-bold"></i>
            <p>Konfirmasi OP</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?= base_url('pendaftaran_op') ?>" class="nav-link">
            <i class="nav-icon fas fa-edit text-bold"></i>
            <p>Pendaftaran OP</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?= base_url('login_devel/logout') ?>" class="nav-link">
