...
<body>
                            ...
                            <form action="" role="form" id="quickForm" method="post">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        <label for="username">Masukkan NIK/NIB anda</label>
                                        <div class="input-group mb-3 kosong">
                                            <input type="text" name="username" id="username" class="form-control" placeholder="NIK/NIB">
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $("#login").on('click', function() {
            $.ajax({
                url: '<?php echo base_url('login_devel/login') ?>',
                type: 'POST',
                ...
                success: function(data) {
                    if (data.status) {
                        ...
                        var url = '<?php echo base_url('dashboard_wp') ?>';
                        window.location = url;
                    } else if (data.error) {
                        toastr.error(
                            data.pesan
