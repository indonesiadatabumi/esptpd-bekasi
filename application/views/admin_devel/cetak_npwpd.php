        ...
        <tr>
            ...
            <td>
                <table style="text-align: center; padding: 0;border-collapse: collapse;">
                    ...
                    <tr>
                        <td class="register">NPWPD :<?= $wp_wr_id ?></td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <table cellspacing="1" style="width: 300;border-collapse: collapse;">
                    ...
                    <tr class="kota">
                        <td width="50" valign="top">NOPD</td>
                        <td width="10" valign="top">:</td>
                        <td><?= $npwprd ?></td>
                    </tr>
                ...
                <table cellspacing="1" style="border-collapse: collapse;">
                    <tr>
                        ...
                        <td class="register">
                            ...
                            Kepala Badan Pendapatan Daerah<br /><br /><br /><br />
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>
                            <div style="position: absolute; top: 71mm; left: 55mm;">
                                <img style="WIDTH:105px; HEIGHT:42px;" opacity="0.9" src="<?= base_url('assets/images/ttd_kaban_baru.jpg') ?>">
                            </div>
                            <div style="position: absolute; top: 69mm; left: 40mm;">
                                <img style="WIDTH:60px; HEIGHT:60px;" opacity="0.9" src="<?= base_url('assets/images/stempel_new.jpg') ?>">
                            </div>
