...
<script type="text/javascript">
    ...
    $(document).on('click', '#va', function(e) {
        ...
        var url = "http://simpatda.bekasikota.go.id/API_VA/request_billing";
        let btn = $(this);
        btn.html(`
    ...
    $(document).on('click', '#qris', function(e) {
        ...
        var url = "http://simpatda.bekasikota.go.id/api_qris/request_qris";
                ...
                if (response['status'] == 'Create QRIS Gagal'){
                    ...
                    Swal.fire({
                        ...
                        html: `
                            ...
                            <div class="row mb-3">
                                <div class="col text-center">
                                    <img src="http://simpatda.bekasikota.go.id/api_qris/assets/qris/` + response['kode_billing'] + `.png" alt="">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col text-center">
                                    <a class = "btn btn-primary btn-search" href = "http://simpatda.bekasikota.go.id/api_qris/assets/qris/` + response['kode_billing'] + `.png" title = "Download" download><i class="bi bi-download"></i> Download</a>
                                </div>
                            </div>`,
                        showCloseButton: true,
                        showConfirmButton: false,
