                    ...
                    <form name="sptpdForm" id="form" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="spt_periode" id="spt_periode" size="11" value="<?= date('Y') ?>" class="form-control-sm" style="background-color:bisque;" readonly/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="spt_pajak" id="spt_pajak" class="form-control-sm is-valid" size="20" onfocus="this.value=unformatCurrency(this.value);" onkeyup="getPengenaan('spt_pajak','spt_nilai','korek_persen_tarif');" onblur="getPengenaan('spt_pajak','spt_nilai','korek_persen_tarif');this.value=formatCurrency(this.value);" style="font-weight:bold;font-size:25px;color:#18F518;background-color:gray;text-align:right;" required />
                                </td>
                            </tr>
                            <tr>
                                <td>Dasar Pengenaan
                                ...
                                <td>
                                    <input type="text" name="spt_nilai" id="spt_nilai" class="inputbox is-valid" size="25" readonly="true" style="font-weight:bold;text-align:right;background-color:azure;" required />
