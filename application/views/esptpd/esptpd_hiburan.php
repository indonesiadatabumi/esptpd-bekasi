...
<script>
    $(document).ready(function() {
        $("select[name=kode_rekening_id]").change(function() {
            var rek_id = $("#kode_rekening_id").val();
            $.ajax({
                type: "POST",
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">
                            ...
                            Input SPTPD PBJT Jasa Kesenian Hiburan
                        </h3>
                    </div>
                    ...
                    <form name="sptpdForm" id="form" method="post" enctype="multipart/form-data">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- <select name="kode_rekening_id" id="kode_rekening_id" style="width:200px; ">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <label for="dasar pengenaan"> Tarif (%) : </label> <input type="text" name="korek_persen_tarif" id="korek_persen_tarif" class="inputbox" value="10" size="5" readonly="true" style="font-weight:bold;background-color:azure;text-align:right;" />
                                </td>
                            </tr>
                            <tr>
