        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="card card-info">
                    ...
                    <form name="sptpdForm" id="form" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="spt_jenis" id="spt_jenis" class="form-control-sm" value="<?= $kd_jns_pajak ?>" size="3" readonly="true" style="background-color:azure;" />
                        ...
                        <input type="hidden" name="kd_rekening" id="kd_rekening" class="form-control-sm" value="<?= $kd_rekening ?>" size="30" readonly="true" style="background-color:azure;" />
                        <input type="hidden" name="kd_spt" id="kd_spt" class="form-control-sm" value="<?= $kode_spt ?>" size="3" readonly="true" style="background-color:azure;" />
                        <input type="hidden" name="no_sptpd" id="no_sptpd" class="form-control-sm mandatory" size="15" value="<?= $no_register ?>" maxlength="5" readonly="true" style="background-color:azure;" />
                        <table class="table">
                            <tr>
                                <td>
                        ...
                        <!-- <tr>
                            ...
                            <tr>
                                <td>
                                    <label for="nama_wp">Jenis Pajak</label>
                                </td>
                                <td>
                                    <input type="text" name="jenis_pajak" id="jenis_pajak" class="form-control-sm" size="40" readonly="true" value="<?= $nama_pajak ?>" style="background-color:azure;text-transform: uppercase;" />
                            </tr>
                            <tr>
                                <td valign="top">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="spt_pajak" id="spt_pajak" class="inputbox" size="20" onkeyup="this.value=formatCurrency(this.value);" style="font-weight:bold;font-size:25px;color:#18F518;background-color:black;text-align:right;">
                                </td>
                            </tr>
                        </table>
                        <!-- akhir inputan -->
            ...
            <div class="col-md-12">
                <div class="card-footer">
                    ...
                    <input type="button" name="submit" class="btn btn-info float-right" id="btnSave" onclick="save()" value="Generate"></input>
                </div>
                </form>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function save() {
        var url = "<?php echo site_url('esptpd/generate_billing') ?>";
