                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="kode_rekening_id" id="kode_rekening_id" style="width:200px; ">
                                        <option value="38" selected>PBJT Jasa Parkir</option>
...
<script language="javascript" src="<?= base_url('assets/js/pajak_restoran.js') ?>"></script>