...
<script>
     ...
     * @returns
     */
    var removeFormField = function(id, id_detail) {
        var x = window.confirm('Anda yakin akan menghapus detail tersebut?');
        if (x) {
            $.ajax({
                 type: "POST",
                 url: "<?= base_url()?>/esptpd/delete_detail",
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><input type="hidden" name="kode_billing" id="kode_billing" class="form-control-sm" value="<?= $kode_billing ?>" size="3" readonly="true" style="background-color:azure;" />
                                    ...
                                    <input type="hidden" name="kd_rekening" id="kd_rekening" class="form-control-sm" value="41108" size="30" readonly="true" style="background-color:azure;" />
                                        ...
                                        <div class="col-xs-3 col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="searchStartDate" data-target-input="nearest">
                                                    ...
                                                    <input type="text" class="form-control datetimepicker-input StartDate" name="spt_periode_jual1" id="StartDate" value="<?= $masa_awal ?>" maxlength="12" placeholder="yyyy-mm-dd" style="background-color:bisque;" data-target="#searchStartDate" readonly/>
                                        ...
                                        <div class="col-xs-3 col-sm-3">
                                            <div class="form-group">
                                                <div class="input-group date" id="searchEndDate" data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input EndDate" name="spt_periode_jual2" id="EndDate" value="<?= $masa_akhir ?>" maxlength="12" placeholder="yyyy-mm-dd" style="background-color:bisque;" data-target="#searchEndDate" readonly/>
                                                            ...
                                                            <tbody id="tbody_detail">
                                                                ...
                                                                ?>
                                                                    <tr class="row0" id="row_detail<?= $counter ?>">
                                                                        ...
                                                                        <td>
                                                                            <a href="#" class="btn btn-xs btn-outline-danger" onClick="removeFormField('#row_detail<?= $counter ?>', '<?= $detail->spt_dt_id ?>');calc1();return false;"><i class="fa fa-trash-alt"></i> Hapus</a>
                                                                        </td>
                                                                    </tr>
...
<script type="text/javascript">
    ...
    function save() {
        if ($('#disclamer').is(":checked")) {
            ...
            var url = "<?php echo site_url('esptpd/update_hp') ?>";
