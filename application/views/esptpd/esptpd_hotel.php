                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">
                            ...
                            Input SPTPD PBJT Jasa Perhotelan
                        </h3>
                    </div>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- <input type="text" name="spt_periode" id="spt_periode" size="11" value="<?= substr($masa_awal, 0, 4) ?>" class="form-control-sm" readonly="true" style="background-color:azure;" /> -->
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="hidden" name="kd_rekening" id="kd_rekening" class="form-control-sm" value="2" size="30" readonly="true" style="background-color:azure;" />
                                    <input type="text" class="form-control-sm" value="41101" size="30" readonly="true" style="background-color:azure;" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <label for="dasar pengenaan"> Tarif (%) : </label>
                                    <input type="text" name="korek_persen_tarif" id="korek_persen_tarif" class="inputbox is-valid" size="5" readonly="true" style="font-weight:bold;background-color:azure;text-align:right;" required />
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div class="col-sm-12">
                        <div class="callout callout-danger">
                            ...
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="imagefile" accept="application/pdf" style="color:red;" required> * Upload file Pdf</label>
                            </div>
                        </div>
                    </div>
                </div>
