                        ...
                        <form id='form' name='form' class='form-horizontal form-label-left' method='POST'>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <label class='col-md-4 control-label'> * Upload Ulang Lampiran</label>
                                        <div class='col-md-8'>
                                            <input type="file" class="form-control" name="imagefile" id="imagefile">
                                            <button type="button" class="btn btn-sm btn-primary" onclick="upload()">upload</button>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    function upload() {
        const kode_billing = $('#id_billing').val()
        ...
        formData.append('kode_billing', kode_billing); // Tambahkan kode billing ke FormData

        // Kirim file dan kode billing ke server dengan AJAX
        $.ajax({
            url: '<?php echo site_url('esptpd/update_lapor') ?>', // Ganti dengan endpoint server-mu
            type: 'POST',
            data: formData,
            dataType: "json",
