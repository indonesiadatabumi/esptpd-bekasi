...
class Pendaftaranwp extends CI_Controller
{
    ...
    function register_user()
    {
        ...
        if ($this->Mod_pendaftaranwp->is_exist_wp_users($npwpd) == true) {
            ...
            // var_dump($arr_save);
            $this->Mod_pendaftaranwp->insert_register('tbl_users', $arr_save);
    ...
    function insert_data()
    {
        ...
        $wp_wr_lurah_nama = $this->Mod_pendaftaranwp->get_nm_kelurahan($wp_wr_kd_lurah);
    ...
    public function sendmail()
    {
        ...
        $config = array(
            ...
            'smtp_host' => 'mail.bekasikota.go.id',
            'smtp_port' => 25,
            'smtp_user' => 'opd.bapenda@bekasikota.go.id',
            'smtp_pass' => 'opd_bapenda_123',
            'smtp_keepalive' => TRUE,
            'smtp_crypto' => 'SSL',
            'wordwrap'  => TRUE,
            'wrapchars' => 80,
        ...
        $this->email->from('opd.bapenda@bekasikota.go.id', 'no-reply@bapenda.bekasi.go.id');
