...
class Esptpd_devel extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('Mod_esptpd_devel');
    }
    ...
    public function index()
    {
        ...
        if ($logged_in != TRUE || empty($logged_in)) {
            ...
            $data['esptpd'] = $this->Mod_esptpd_devel->_get_esptpd_menu();
            // var_dump($data['esptpd']);die;
            // $data['menu'] = $this->Mod_esptpd_devel->_get_table_menu();
            $data['Mod_esptpd_devel'] = $this->Mod_esptpd_devel;
            $this->template->load('layoutbackend_devel', 'esptpd_devel/esptpd_menu', $data);
        }
    }
    ...
    public function billing()
    {
        ...
        // if ($kb == 2) {
        //     $noreg = $wp_id;
        //     $list = $this->Mod_esptpd_devel->_get_id_npwp($noreg);
        //     foreach ($list as $apl) {
        //         $wp_id = $apl->wp_wr_id;
        //         $npwprd = $apl->npwprd;
        //     }
        ...
        //         $list = $this->Mod_esptpd_devel->_get_data_wp(substr($this->session->userdata('username'), 7, 7));
        //         foreach ($list as $apl) {
        //             $wp_id = $apl->wp_wr_id;
        //         }
        //     }
        ...
        $espt = $this->Mod_esptpd_devel->_get_esptpd_menu_group($noreg);
        ...
        $this->template->load('layoutbackend_devel', 'esptpd/billing_data', $data);
    }
    ...
    public function billing_new()
    {
        ...
        $data['npwprd'] = $npwprd;
        $data['wp_wr_nama'] = $wp_wr_nama;
        $this->template->load('layoutbackend_devel', 'esptpd/billing_data_new', $data);
    }
    ...
    public function print_billing_group()
    {
        ...
        $this->template->load('layoutbackend_devel', 'esptpd/print_billing_group');
    }

    public function tambah_data_group()
    {
        $this->template->load('layoutbackend_devel', 'esptpd/tambah_data_group');
    }
    ...
    public function get_nama_wp()
    {
        ...
        $nama = $this->Mod_esptpd_devel->get_nama_wp($npwprd);
    ...
    public function save_data_group()
    {
        ...
        $arr_noreg = $this->Mod_esptpd_devel->_get_id_npwp($noreg);
        ...
        $this->Mod_esptpd_devel->inserSPT("data_group", $save);
    ...
    public function billing_hapus()
    {
        ...
        $spt_id = $this->Mod_esptpd_devel->get_sptID($where, 'spt');

        $where2 = array('spt_id' => $spt_id);
        $this->Mod_esptpd_devel->hapus_billing($where2, 'spt');

        $where3 = array('spt_dt_id_spt' => $spt_id);
        $this->Mod_esptpd_devel->hapus_billing($where3, 'spt_detail');
    ...
    public function delete_menu()
    {
        ...
        $this->Mod_esptpd_devel->hapus_billing($where, 'data_group');
    ...
    public function lampiran()
    {
        ...
        $list = $this->Mod_esptpd_devel->getAll($billing_id);
    ...
    public function register()
    {
        ...
        $list2 = $this->Mod_esptpd_devel->getdataPayment($billing_id);
        ...
        $list3 = $this->Mod_esptpd_devel->getdataPelayanan($billing_id);
        ...
        $this->template->load('layoutbackend_devel', 'esptpd/esptpd_register', $data);
    }
    ...
    public function lihat_lampiran()
    {
        ...
        $this->template->load('layoutbackend_devel', 'esptpd/esptpd_lihat_lampiran', $data);
    }
    ...
    public function view()
    {
        ...
        $data['billing_id'] = $billing_id;
        $this->template->load('layoutbackend_devel', 'esptpd/billing_view', $data);
    }
    ...
    public function espt_print()
    {
        ...
        $list = $this->Mod_esptpd_devel->getPrint($spt_id);
        $data['list'] = $list;
        foreach ($list as $billing) {
        ...
        $list_npwp = $this->Mod_esptpd_devel->getWPWRD($billing->spt_idwpwr);
        ...
        if ($explode[0] <= '2023' && $explode[1] <= '12') {// jatuh tempo bayar
            ...
            if(date('d') > '15' && $billing->status_bayar == 0){
                ...
                if ($explode_pajak_lalu[0] <= '2023' && $explode_pajak_lalu[1] <= '16') {
                    ...
                    $cek_lapor_pajak = $this->Mod_esptpd_devel->cek_lapor_pajak($pajak_lalu, $billing->spt_idwpwr);
            ...
            // $cek_lapor_pajak = $this->Mod_esptpd_devel->cek_lapor_pajak($billing->spt_periode_jual1, $billing->spt_idwpwr);
        ...
        if ($billing->status_bayar == 0) {
            ...
            // $tgl_setor = '';
            // $list_denda = $this->Mod_esptpd_devel->getDenda($billing->spt_idwpwr, $billing->spt_periode, $billing->spt_nomor);
            ...
            $get_denda = $this->Mod_esptpd_devel->getDendaLunas($billing->spt_kode_billing, $billing->spt_periode);
        ...
        // die();
        $mpdf = new \Mpdf\Mpdf();
        // $this->template->load('layoutbackend_devel', 'esptpd/esptpd_resto_prt', $data);
    ...
    public function espt_print_prt()
    {
        ...
        $list_bil = $this->Mod_esptpd_devel->getAll($billing_id);
        foreach ($list_bil as $billing2) {
            $data['spt_id'] = $billing2->spt_id;
        }

        $list = $this->Mod_esptpd_devel->getPrint($billing2->spt_id);
        foreach ($list as $billing) {
            $data['spt_nomor'] = $billing->spt_nomor;
            $data['spt_tahun_pajak'] = $billing->tahunpajak;
            $data['spt_idwpwr'] = $billing->spt_idwpwr;
    ...
    public function espt_billing_new()
    {
        ...
        $list = $this->Mod_esptpd_devel->getPrintNew($spt_id);
        foreach ($list as $billing) {
            $data['spt_nomor'] = $billing->spt_nomor;
            $data['spt_tahun_pajak'] = $billing->tahunpajak;
            $data['spt_idwpwr'] = $billing->spt_idwpwr;
    ...
    public function espt_group_prt()
    {
        ...
        $data['billing_induk'] = $this->Mod_esptpd_devel->get_group_billing($periode, $jual1, $jual2, $this->session->userdata('id_user'));
        $data['billing_anak'] = $this->Mod_esptpd_devel->get_group_billing_det($periode, $jual1, $jual2, $this->session->userdata('id_user'));

        $mpdf = new \Mpdf\Mpdf();
        // $this->template->load('layoutbackend_devel', 'esptpd/esptpd_group_prt', $data);
    ...
    public function ajax_list()
    {
        ...
        $list = $this->Mod_esptpd_devel->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        foreach ($list as $biling) {
            ...
            if ($biling->status_bayar == 0) {
                ...
                $tgl_setor = '';
                $list_denda = $this->Mod_esptpd_devel->getDenda($biling->spt_idwpwr, $biling->spt_periode, $biling->spt_nomor);
                foreach ($list_denda as $list_denda) {
                    $tgl_setor = $list_denda->setorpajret_tgl_bayar;
                }
            ...
            $list3 = $this->Mod_esptpd_devel->getdataPelayanan($biling->spt_kode_billing);
            foreach ($list3 as $pelayanan) {
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->Mod_esptpd_devel->count_all(),
            "recordsFiltered" => $this->Mod_esptpd_devel->count_filtered(),
            "data" => $data,
        );
        ...
        foreach ($list as $biling) {
            ...
            if ($explode[0] <= '2023' && $explode[1] <= '10' || $biling->spt_periode_jual1 < '2024-01-01') {
                ...
                if(date('d') > '15' && $biling->status_bayar == 0){//jatuh tempo lapor
                    ...
                    if ($explode_pajak_lalu[0] <= '2023' && $explode_pajak_lalu[1] <= '10') {//jatuh tempo bayar
                        ...
                        $cek_lapor_pajak = $this->Mod_esptpd_devel->cek_lapor_pajak($pajak_lalu, $biling->spt_idwpwr);
            ...
            if($biling->status_bayar == 0){
                ...
                if($biling->tgl_lapor == null){
                    ...
                    // $aksi = "<a class=\"btn btn-xs btn-outline-primary\" href='#'><i class=\"fas fa-edit\"></i> Edit Laporan</a>
                    //     <a class=\"btn btn-xs btn-outline-info\" href=\"javascript:void(0)\" id=\"esptpd\" title=\"esptpd\" data-href=" . $biling->spt_id . "/" . $biling->spt_jenis_pajakretribusi . "><i class=\"fas fa-print\"></i> Esptpd</a>
                    //     <a class=\"btn btn-xs btn-outline-success\" href=\"javascript:void(0)\" id=\"billing\" title=\"billing\" data-href=" . $biling->spt_id . "/" . $biling->spt_jenis_pajakretribusi . "><i class=\"fas fa-print\"></i> Billing</a>
                    //     <a class=\"btn btn-xs btn-outline-warning\" id=\"edit\" href=\"javascript:void(0)\" title=\"Edit\" data-href=" . $biling->spt_kode_billing . "><i class=\"fas fa-link\"> Lampiran</i></a>";
                    $aksi = "<a class=\"btn btn-xs btn-outline-info\" href=\"javascript:void(0)\" id=\"esptpd\" title=\"esptpd\" data-href=" . $biling->spt_id . "/" . $biling->spt_jenis_pajakretribusi . "><i class=\"fas fa-print\"></i> Esptpd</a>
    ...
    function add()
    {
        ...
        if ($kodus_id == 1) {
            ...
            $kd_jns = '1';
            $list_rekening = $this->Mod_esptpd_devel->_get_rekening('4', '1', '1', '01');
            $data['list_rekening'] = $list_rekening;
        } elseif ($kodus_id == 5 || $kodus_id == 12) {
            $add_form =  "esptpd_ppj";
            $kd_jns = '5';
            $data['v_rekening'] = $this->Mod_esptpd_devel->get_v_rekening_ppj('41105');
        } elseif ($kodus_id == 11) {
        ...
        $apl = '';
        $list = $this->Mod_esptpd_devel->_get_data_wp($no_reg);
        foreach ($list as $apl) {
        ...
        $list_spt = $this->Mod_esptpd_devel->_get_data_SPPT($apl->wp_wr_id);
        ...
        $this->template->load('layoutbackend_devel', 'esptpd/' . $add_form, $data);
        // $this->template->load('layoutbackend_devel', 'esptpd/generate_billing', $data);
    }
    ...
    function daftar_billing()
    {
        ...
        $list = $this->Mod_esptpd_devel->data_wp($no_reg);
        ...
        $data['no_register'] = $kode_spt;
        $list_spt = $this->Mod_esptpd_devel->_get_data_SPPT($list->wp_wr_id);
        $masa_awal = $list_spt->spt_periode_jual1;
        $masa_akhir = $list_spt->spt_periode_jual2;
    ...
    function editesptpd()
    {
        ...
        if ($jns_pajak == 1) {
            ...
            $list_rekening = $this->Mod_esptpd_devel->_get_rekening('4', '1', '1', '06');
            $data['list_rekening'] = $list_rekening;
        } elseif ($jns_pajak == 5) {
        ...
        if ($jns_pajak == '3' || $jns_pajak == '7') {
            $list_spt = $this->Mod_esptpd_devel->get_edit_esptpd_det($jns_pajak, $spt_id);
            $data['espt_detil'] = $this->Mod_esptpd_devel->get_esptpd_detil($spt_id);
            if ($jns_pajak == '3') {
                $kode_rek = '41103';
            } elseif ($jns_pajak == '7') {
                $kode_rek = '41107';
            }
            $data['v_rekening'] = $this->Mod_esptpd_devel->get_v_rekening($kode_rek);
        } elseif ($jns_pajak == '5') {
            $list_spt = $this->Mod_esptpd_devel->get_edit_esptpd_det($jns_pajak, $spt_id);
            $kode_rek = '41105';
            $data['spt_dt_korek'] = $list_spt->spt_dt_korek;
            $data['spt_dt_persen_tarif'] = $list_spt->spt_dt_persen_tarif;
            $data['v_rekening'] = $this->Mod_esptpd_devel->get_v_rekening_ppj($kode_rek);
        } else {
            $list_spt = $this->Mod_esptpd_devel->get_edit_esptpd($spt_id);
    ...
    function edit_billing()
    {
        ...
        $list_spt = $this->Mod_esptpd_devel->data_spt($spt_id);
        ...
        $this->template->load('layoutbackend_devel', 'esptpd/edit_billing', $data);
    }
    ...
    function lapor_pajak() {
        ...
        $this->template->load('layoutbackend_devel', 'esptpd/' . $form_lapor, $data);
    }

    function kode_spt($kode_spt, $kd_jns)
    {
        $kode_spt = $this->Mod_esptpd_devel->_get_reg_spt($kode_spt, $kd_jns);
    ...
    function next_spt_no_register()
    {
        ...
        $kode_spt = $this->Mod_esptpd_devel->next_spt_no_register($spt_periode, $kode_spt, $kd_jns);
        $next_spt_no_register = $this->fungsi->tambah_nol($kode_spt, 4);
    ...
    function get_tarif()
    {
        ...
        $tarif = $this->Mod_esptpd_devel->_get_tarif($korek_id);
    ...
    function get_korek()
    {
        ...
        $kode_rek = $this->Mod_esptpd_devel->_get_korek($korek_id);
    ...
    public function generate_billing() {
        ...
        $cek = $this->Mod_esptpd_devel->_cekSPT_nomor($spt_nomor, $this->input->post('spt_periode'), $this->input->post('spt_jenis'));
        $cek_masa_pajak = $this->Mod_esptpd_devel->cek_masa_pajak($this->input->post('spt_periode_jual1'), $this->input->post('spt_periode_jual2'), $this->input->post('wp_id'));
        if($cek > 0){
            ...
            if ($this->input->post('spt_jenis') == '2'){
                ...
                $insert_spt =  $this->Mod_esptpd_devel->inserSPT("spt", $save);
                echo json_encode(array("status" => TRUE));
            }else{
                echo json_encode(array(
                    "error" => True,
    ...
    public function insert()
    {
        ...
        if ($cek  > 0) {
            ...
            if ($this->input->post('spt_jenis') == '2' && $this->input->post('nama_rekening') == '10'){
                ...
                if ($insert_spt > 0) {
                    $spt_id = $this->Mod_esptpd_devel->_getSPT_id();
                    ...
                    $this->Mod_esptpd_devel->inserSPT("spt_detail", $save);
    ...
    public function insert_lapor(){
        ...
        if ($this->upload->do_upload('imagefile')){//jika upload lampiran
            ...
            $update_spt = $this->Mod_esptpd_devel->updateSPT($spt_id, $save);
    ...
    public function update()
    {
        ...
        if ($this->upload->do_upload('imagefile')) {
            ...
            // $this->Mod_esptpd_devel->updateSPT($spt_id, $save);
            ...
            //     'spt_dt_pajak' => $spt_pajak
            // );
            // $this->Mod_esptpd_devel->updateSPTDetil($spt_dt_id, $save);
    ...
    public function update_billing()
    {
        ...
        $update_spt_detail = $this->Mod_esptpd_devel->updateSPTDetail($spt_id, $save_detail);
        echo json_encode(array("status" => TRUE));
    }
        ...
        if ($update_spt > 0) {
            ...
            foreach ($this->input->post('spt_dt_korek') as $key => $value) {
                ...
                if (isset($this->input->post('spt_dt_id')[$key])) {
                    ...
                    $this->Mod_esptpd_devel->inserSPT("spt_detail", $save2);
                }
            }
            echo json_encode(array("status" => TRUE));
        } else
    ...
    public function delete_detail()
    {
        ...
        $delete_detail = $this->Mod_esptpd_devel->delete_spt_detail($id_detail);
    }
    ...
    public function register_insert()
    {
        ...
        $this->Mod_esptpd_devel->insertPelayanan("tbl_pelayanan", $save);
        echo json_encode(array("status" => TRUE));
    }
    ...
    public function register_save()
    {
        ...
        if ($act == 'edit') {
            ...
            $this->Mod_esptpd_devel->updatePelayanan($id_billing, $save);
            echo json_encode(array("status" => TRUE));
        } else {
    ...
    function saveQRCode()
    {
        ...
        $this->Mod_esptpd_devel->insertQRCode($spt_id, $qr_id, $qr_code, $image_name); //simpan ke database
    ...
    {
        $kode_billing = $this->input->post('kode_billing');
        $cek_verifikasi = $this->Mod_esptpd_devel->cek_verifikasi($kode_billing);//cek kode billing udah pernah diverifikasi
        if ($cek_verifikasi == null){
            ...
            $hapus_verifikasi = $this->Mod_esptpd_devel->hapus_verifikasi($kode_billing);//hapus kode billing udah pernah diverifikasi
            $response = [
                'status' => 'true',
