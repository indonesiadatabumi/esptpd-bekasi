...
<head>
    ...
    <!-- title -->
    <title>Portal Pembayaran | Retribusi Daerah</title>
                ...
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Retribusi Daerah</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        function bayar_qris(kode_billing) {
            switch (kode_billing) {
                ...
                case kode_billing:
                    $.ajax({
                        type: "post",
                        url: "http://simpatda.bekasikota.go.id/simpatda_bekasi/api_qris_retribusi/request_qris",
                        data: {
                        ...
                        success: function(response) {
                            ...
                            if (response.status == 'Gagal') { //apabila respon gagal
                                ...
                                Swal.fire({
                                    ...
                                    <div class="row mb-3">
                                        <div class="col text-center">
                                            <img src="http://simpatda.bekasikota.go.id/simpatda_bekasi/api_qris_retribusi/assets/qris/` + response.kode_billing + `.png" alt="">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col text-center">
                                            <a class = "btn btn-primary btn-search" href = "http://simpatda.bekasikota.go.id/simpatda_bekasi/api_qris_retribusi/assets/qris/` + response.kode_billing + `.png" title = "Download" download><i class="bi bi-download"></i> Download</a>
                                        </div>
                                    </div>`,
                                    showCloseButton: true,
                                    showConfirmButton: false,
